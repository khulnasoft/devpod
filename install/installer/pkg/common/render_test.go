...
import (
	...
	content_service "github.com/khulnasoft/devpod/installer/pkg/components/content-service"
...
func TestRepoName(t *testing.T) {
	...
	tests := []struct {
		...
		// Drop repo, namespace
		{
			...
			CfgRepo:       "some.registry.com/devpod",
			DropImageRepo: pointer.Bool(true),
		},
		{
			Repo: "some-repo.com",
			Name: "some-image",
			Expectation: Expectation{
				Result: "some.registry.com/devpod/some-image",
			},
			CfgRepo:       "some.registry.com/devpod",
			DropImageRepo: pointer.Bool(true),
		},
