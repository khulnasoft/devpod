...
import (
	...
	agentSmith "github.com/khulnasoft/devpod/agent-smith/pkg/config"
	"github.com/khulnasoft/devpod/common-go/grpc"
...
type WebAppConfig struct {
	...
	// PublicURL lets you override the publically reachable endpoints of devpod (currently only public api endpoint)
	...
	// ProxySettings is used if the devpod cell uses some proxy for connectivity
