...
import "github.com/khulnasoft/devpod/installer/pkg/components/redis"
...
// WorkspaceCluster from components/devpod-protocol/src/workspace-cluster.ts
...
// WorkspaceClusterState from components/devpod-protocol/src/workspace-cluster.ts
