...
func configmap(ctx *common.RenderContext) ([]runtime.Object, error) {
	...
	counterMetrics := []config.CounterMetricsConfiguration{
		...
		{
			Name: "devpod_supervisor_frontend_error_total",
		...
		{
			Name: "devpod_vscode_web_load_total",
		...
		{
			Name: "devpod_supervisor_frontend_client_total",
			Help: "Total count of supervisor frontend client",
		},
		{
			Name: "devpod_vscode_extension_gallery_operation_total",
		...
		{
			Name: "devpod_vscode_extension_gallery_query_total",
		...
		},
		{
			...
			Labels: []config.LabelAllowList{
				{
					Name:         "origin",
					AllowValues:  []string{"unknown", "workspace", "devpod", "localhost"},
					DefaultValue: "unknown",
				},
				{
					Name:         "instance_phase",
	...
	histogramMetrics := []config.HistogramMetricsConfiguration{
		{
			Name: "devpod_vscode_extension_gallery_operation_duration_seconds",
			...
			Name: "devpod_vscode_extension_gallery_query_duration_seconds",
