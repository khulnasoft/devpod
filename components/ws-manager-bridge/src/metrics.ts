...
export class Metrics {
    ...
    constructor() {
        ...
        this.staleStatusUpdatesTotal = new prom.Counter({
            name: "devpod_ws_manager_bridge_stale_status_updates_total",
        ...
        this.stalePrebuildEventsTotal = new prom.Counter({
            name: "devpod_ws_manager_bridge_stale_prebuild_events_total",
        ...
        this.workspaceInstanceUpdateStartedTotal = new prom.Counter({
            name: "devpod_ws_manager_bridge_workspace_instance_update_started_total",
        ...
        this.workspaceInstanceUpdateCompletedSeconds = new prom.Histogram({
            name: "devpod_ws_manager_bridge_workspace_instance_update_completed_seconds",
