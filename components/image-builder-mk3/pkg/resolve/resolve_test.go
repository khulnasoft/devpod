...
import (
	...
	"github.com/khulnasoft/devpod/image-builder/pkg/resolve"
...
func TestStandaloneRefResolverResolve(t *testing.T) {
	...
	tests := []struct {
		...
		{
			Name: "with-port",
			Ref:  "some-internal-registry.customer.com:5000/devpod/base-image:latest",
			ResolveResponse: ResolveResponse{
				MF: &ociv1.Manifest{Config: ociv1.Descriptor{MediaType: ociv1.MediaTypeImageManifest, Size: 1}},
			},
			Expectation: Expectation{
				Ref: "some-internal-registry.customer.com:5000/devpod/base-image@sha256:839b30716e23e3ac46ed28d6f9fc0f77e3e7121a9b4b2833e8fb6ec4ec89b3bd",
			},
		},
		{
		...
		{
			Name: "not authorized",
			Ref:  "registry-1.testing.devpod-self-hosted.com:5000/devpod/devpod/workspace-full:latest",
			ResolveResponse: ResolveResponse{
		...
		},
		{
			...
			Ref:  "registry-1.docker.io:5000/devpod/devpod/workspace-full:latest-pulled-too-often",
			ResolveResponse: ResolveResponse{
				Error: errors.New("httpReadSeeker: failed open: unexpected status code https://registry-1.docker.io/v2/devpod/workspace-full/manifests/sha256:279f925ad6395f11f6b60e63d7efa5c0b26a853c6052327efbe29bbcc0bafd6a: 429 Too Many Requests - Server message: toomanyrequests: You have reached your pull rate limit. You may increase the limit by authenticating and upgrading: https://www.docker.com/increase-rate-limit"),
			},
			Expectation: Expectation{
