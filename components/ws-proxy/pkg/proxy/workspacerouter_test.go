...
func TestWorkspaceRouter(t *testing.T) {
	const wsHostRegex = "\\.ws\\.devpod\\.dev"
	const wsHostSuffix = ".ws.devpod.dev"
	...
	tests := []struct {
	...
	}{
		{
			...
			URL:  "http://amaranth-smelt-9ba20cc1.ws.devpod.dev/",
			Headers: map[string]string{
				forwardedHostnameHeader: "amaranth-smelt-9ba20cc1.ws.devpod.dev",
			},
		...
		},
		{
			...
			URL:  "http://debug-amaranth-smelt-9ba20cc1.ws.devpod.dev/",
			Headers: map[string]string{
				forwardedHostnameHeader: "debug-amaranth-smelt-9ba20cc1.ws.devpod.dev",
			},
			Router:       HostBasedRouter(forwardedHostnameHeader, wsHostSuffix, wsHostRegex),
			WSHostSuffix: wsHostSuffix,
			Expected: Expectation{
		...
		},
		{
			...
			URL:  "http://1234-amaranth-smelt-9ba20cc1.ws.devpod.dev/",
			Headers: map[string]string{
				forwardedHostnameHeader: "1234-amaranth-smelt-9ba20cc1.ws.devpod.dev",
			},
			Router:       HostBasedRouter(forwardedHostnameHeader, wsHostSuffix, wsHostRegex),
			WSHostSuffix: wsHostSuffix,
			Expected: Expectation{
		...
		},
		{
			...
			URL:  "http://1234-debug-amaranth-smelt-9ba20cc1.ws.devpod.dev/",
			Headers: map[string]string{
				forwardedHostnameHeader: "1234-debug-amaranth-smelt-9ba20cc1.ws.devpod.dev",
			},
			Router:       HostBasedRouter(forwardedHostnameHeader, wsHostSuffix, wsHostRegex),
			WSHostSuffix: wsHostSuffix,
			Expected: Expectation{
...
func TestMatchWorkspaceHostHeader(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			Path:       "eu.gcr.io/devpod-core-dev/build/ide/code:nightly@sha256:41aeea688aa0943bd746cb70c4ed378910f7c7ecf56f5f53ccb2b76c6b68e1a7/__files__/index.html",
		},
		{
			Name:       "no match 3",
