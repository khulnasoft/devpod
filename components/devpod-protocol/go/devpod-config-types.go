...
type Prebuilds_object struct {
	...
	// Add a label to a PR when it's prebuilt. Set to true to use the default label (prebuilt-in-devpod) or set to a string to use a different label name. This is a beta feature and may be unreliable. Defaults to false.
