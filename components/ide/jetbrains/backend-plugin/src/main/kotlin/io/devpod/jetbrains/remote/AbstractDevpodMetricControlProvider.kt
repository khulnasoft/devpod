...
abstract class AbstractGitpodMetricControlProvider : MetricControlProvider {
    ...
    private fun createWorkspaceHeaderRow(ctx: VerticalGridBuilder, backendDiagnosticsService: IBackendDiagnosticsService, lifetime: Lifetime) {
        ...
        val workspaceClassMetric = backendDiagnosticsService.getMetric("devpod_workspace_class")
    ...
    private fun createCpuControl(ctx: VerticalGridBuilder, backendDiagnosticsService: IBackendDiagnosticsService, lifetime: Lifetime) {
        val cpuUsed = backendDiagnosticsService.getMetric("devpod_workspace_cpu_used")
        val cpuTotal = backendDiagnosticsService.getMetric("devpod_workspace_cpu_total")
        val cpuPercentage = backendDiagnosticsService.getMetric("devpod_workspace_cpu_percentage")
    ...
    private fun createMemoryControl(ctx: VerticalGridBuilder, backendDiagnosticsService: IBackendDiagnosticsService, lifetime: Lifetime) {
        val memoryUsed = backendDiagnosticsService.getMetric("devpod_workspace_memory_used")
        val memoryTotal = backendDiagnosticsService.getMetric("devpod_workspace_memory_total")
        val memoryPercentage = backendDiagnosticsService.getMetric("devpod_workspace_memory_percentage")
