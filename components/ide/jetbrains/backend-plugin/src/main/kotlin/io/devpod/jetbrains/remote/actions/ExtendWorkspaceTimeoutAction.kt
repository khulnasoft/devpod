...
import io.devpod.devpodprotocol.api.entities.WorkspaceTimeoutDuration
...
// validation from https://github.com/khulnasoft/devpod/blob/74ccaea38db8df2d1666161a073015485ebb90ca/components/devpod-protocol/src/devpod-service.ts#L361-L383
            ...
            if (dialog.showAndGet()) {
                ...
                manager.client.server.setWorkspaceTimeout(workspaceInfo.workspaceId, duration.toString()).whenComplete { result, e ->
                    ...
                    if (e != null) {
                        ...
                        thisLogger().error("devpod: failed to extend workspace timeout", e)
                    } else {
