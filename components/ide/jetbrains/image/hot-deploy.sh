...
leeway build -Dversion="$version" -DimageRepoBase=eu.gcr.io/devpod-dev-artifact/build -DbuildNumber="$IDE_BUILD_VERSION" -DjbBackendVersion="$IDE_VERSION" ".:$component" --save "$bldfn"
