...
import (
	...
	"github.com/khulnasoft/devpod/common-go/watch"
	devpodapi "github.com/khulnasoft/devpod/devpod-protocol"
	api "github.com/khulnasoft/devpod/ide-service-api"
	"github.com/khulnasoft/devpod/ide-service-api/config"
...
func getProductConfig(config *devpodapi.GitpodConfig, alias string) *devpodapi.JetbrainsProduct {
	...
	productConfig, ok := v.(*devpodapi.JetbrainsProduct)
	if !ok {
		return nil
	}
