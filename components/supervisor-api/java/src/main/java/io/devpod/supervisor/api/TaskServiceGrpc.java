...
public final class TaskServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.devpod.supervisor.api.Task.ListenToOutputRequest,
      io.devpod.supervisor.api.Task.ListenToOutputResponse> getListenToOutputMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListenToOutput",
      requestType = io.devpod.supervisor.api.Task.ListenToOutputRequest.class,
      responseType = io.devpod.supervisor.api.Task.ListenToOutputResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<io.devpod.supervisor.api.Task.ListenToOutputRequest,
      io.devpod.supervisor.api.Task.ListenToOutputResponse> getListenToOutputMethod() {
    io.grpc.MethodDescriptor<io.devpod.supervisor.api.Task.ListenToOutputRequest, io.devpod.supervisor.api.Task.ListenToOutputResponse> getListenToOutputMethod;
      ...
      synchronized (TaskServiceGrpc.class) {
        if ((getListenToOutputMethod = TaskServiceGrpc.getListenToOutputMethod) == null) {
          TaskServiceGrpc.getListenToOutputMethod = getListenToOutputMethod =
              io.grpc.MethodDescriptor.<io.devpod.supervisor.api.Task.ListenToOutputRequest, io.devpod.supervisor.api.Task.ListenToOutputResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListenToOutput"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.devpod.supervisor.api.Task.ListenToOutputRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.devpod.supervisor.api.Task.ListenToOutputResponse.getDefaultInstance()))
  ...
  public static abstract class TaskServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void listenToOutput(io.devpod.supervisor.api.Task.ListenToOutputRequest request,
        io.grpc.stub.StreamObserver<io.devpod.supervisor.api.Task.ListenToOutputResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                io.devpod.supervisor.api.Task.ListenToOutputRequest,
                io.devpod.supervisor.api.Task.ListenToOutputResponse>(
  ...
  public static final class TaskServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TaskServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<io.devpod.supervisor.api.Task.ListenToOutputResponse> listenToOutput(
        io.devpod.supervisor.api.Task.ListenToOutputRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LISTEN_TO_OUTPUT:
          serviceImpl.listenToOutput((io.devpod.supervisor.api.Task.ListenToOutputRequest) request,
              (io.grpc.stub.StreamObserver<io.devpod.supervisor.api.Task.ListenToOutputResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class TaskServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.devpod.supervisor.api.Task.getDescriptor();
    }
