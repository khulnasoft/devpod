...
public final class InfoServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.devpod.supervisor.api.Info.WorkspaceInfoRequest,
      io.devpod.supervisor.api.Info.WorkspaceInfoResponse> getWorkspaceInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "WorkspaceInfo",
      requestType = io.devpod.supervisor.api.Info.WorkspaceInfoRequest.class,
      responseType = io.devpod.supervisor.api.Info.WorkspaceInfoResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.devpod.supervisor.api.Info.WorkspaceInfoRequest,
      io.devpod.supervisor.api.Info.WorkspaceInfoResponse> getWorkspaceInfoMethod() {
    io.grpc.MethodDescriptor<io.devpod.supervisor.api.Info.WorkspaceInfoRequest, io.devpod.supervisor.api.Info.WorkspaceInfoResponse> getWorkspaceInfoMethod;
      ...
      synchronized (InfoServiceGrpc.class) {
        if ((getWorkspaceInfoMethod = InfoServiceGrpc.getWorkspaceInfoMethod) == null) {
          InfoServiceGrpc.getWorkspaceInfoMethod = getWorkspaceInfoMethod =
              io.grpc.MethodDescriptor.<io.devpod.supervisor.api.Info.WorkspaceInfoRequest, io.devpod.supervisor.api.Info.WorkspaceInfoResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "WorkspaceInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.devpod.supervisor.api.Info.WorkspaceInfoRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.devpod.supervisor.api.Info.WorkspaceInfoResponse.getDefaultInstance()))
  ...
  public static abstract class InfoServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void workspaceInfo(io.devpod.supervisor.api.Info.WorkspaceInfoRequest request,
        io.grpc.stub.StreamObserver<io.devpod.supervisor.api.Info.WorkspaceInfoResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                io.devpod.supervisor.api.Info.WorkspaceInfoRequest,
                io.devpod.supervisor.api.Info.WorkspaceInfoResponse>(
  ...
  public static final class InfoServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<InfoServiceBlockingStub> {
    ...
    /**
     */
    public io.devpod.supervisor.api.Info.WorkspaceInfoResponse workspaceInfo(io.devpod.supervisor.api.Info.WorkspaceInfoRequest request) {
  ...
  public static final class InfoServiceFutureStub extends io.grpc.stub.AbstractFutureStub<InfoServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.devpod.supervisor.api.Info.WorkspaceInfoResponse> workspaceInfo(
        io.devpod.supervisor.api.Info.WorkspaceInfoRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_WORKSPACE_INFO:
          serviceImpl.workspaceInfo((io.devpod.supervisor.api.Info.WorkspaceInfoRequest) request,
              (io.grpc.stub.StreamObserver<io.devpod.supervisor.api.Info.WorkspaceInfoResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class InfoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.devpod.supervisor.api.Info.getDescriptor();
    }
