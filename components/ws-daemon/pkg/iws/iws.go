...
import (
	...
	"github.com/khulnasoft/devpod/common-go/cgroups"
	v2 "github.com/khulnasoft/devpod/common-go/cgroups/v2"
	"github.com/khulnasoft/devpod/common-go/log"
	"github.com/khulnasoft/devpod/common-go/tracing"
	wsinit "github.com/khulnasoft/devpod/content-service/pkg/initializer"
	"github.com/khulnasoft/devpod/ws-daemon/api"
	"github.com/khulnasoft/devpod/ws-daemon/pkg/container"
	"github.com/khulnasoft/devpod/ws-daemon/pkg/internal/session"
	nsi "github.com/khulnasoft/devpod/ws-daemon/pkg/nsinsider"
)
...
// └── workspace       drwxr-xr-x 5 devpodUid devpodGid
//
//	└── user        drwxr-xr-x 5 devpodUid devpodGid
