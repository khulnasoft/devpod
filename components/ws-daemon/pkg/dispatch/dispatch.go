...
func (d *Dispatch) handlePodUpdate(oldPod, newPod *corev1.Pod) {
	...
	if !ok {
		...
		// Important!!!!: ideally this timeout must be equal to ws-manager https://github.com/khulnasoft/devpod/blob/main/components/ws-manager/pkg/manager/manager.go#L171
