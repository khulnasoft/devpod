...
const (
	workspaceDownloadModule = "devpod.workspace_download"
)
...
// Download implements an HTTP handler that extracts devpod headers
...
func (Download) CaddyModule() caddy.ModuleInfo {
	return caddy.ModuleInfo{
		ID:  "http.handlers.devpod_workspace_download",
