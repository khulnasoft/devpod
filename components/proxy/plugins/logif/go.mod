module github.com/khulnasoft/devpod/proxy/plugins/logif

go 1.21

replace github.com/khulnasoft/devpod/proxy/plugins/jsonselect => ../jsonselect

require (
	github.com/PaesslerAG/gval v1.2.2
	github.com/buger/jsonparser v1.1.1
	github.com/caddyserver/caddy/v2 v2.7.6
	github.com/khulnasoft/devpod/proxy/plugins/jsonselect v0.0.0-00010101000000-000000000000
