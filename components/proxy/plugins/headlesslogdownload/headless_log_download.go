...
const (
	headlessLogDownloadModule = "devpod.headless_log_download"
)
...
// HeadlessLogDownload implements an HTTP handler that extracts devpod headers
...
func (HeadlessLogDownload) CaddyModule() caddy.ModuleInfo {
	return caddy.ModuleInfo{
		ID:  "http.handlers.devpod_headless_log_download",
