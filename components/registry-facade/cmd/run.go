...
import (
	...
	"github.com/khulnasoft/devpod/common-go/kubernetes"
	...
	"github.com/khulnasoft/devpod/registry-facade/api/config"
	"github.com/khulnasoft/devpod/registry-facade/pkg/registry"
)
...
var runCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		gpreg := prometheus.WrapRegistererWithPrefix("devpod_registry_facade_", promreg)
