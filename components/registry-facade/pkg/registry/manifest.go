...
func (reg *Registry) handleManifest(ctx context.Context, r *http.Request) http.Handler {
	...
	if err != nil {
		...
		// ref: https://github.com/khulnasoft/devpod/blob/1a3c4b0bb6f13fe38481d21ddd146747c1a1935f/components/node-labeler/cmd/run.go#L291
...
func (mh *manifestHandler) getManifest(w http.ResponseWriter, r *http.Request) {
	...
	err := func() error {
		...
		case images.MediaTypeDockerSchema2Manifest, ociv1.MediaTypeImageManifest:
			...
			manifest.Annotations["io.devpod.workspace-image.size"] = strconv.Itoa(originImageSize)
			manifest.Annotations["io.devpod.workspace-image.ref"] = mh.Spec.BaseRef
			...
			//
			// fixes https://github.com/khulnasoft/devpod/pull/3397
