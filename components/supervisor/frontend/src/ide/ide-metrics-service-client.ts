...
export enum MetricsName {
    SupervisorFrontendClientTotal = "devpod_supervisor_frontend_client_total",
    SupervisorFrontendErrorTotal = "devpod_supervisor_frontend_error_total",
    SupervisorFrontendLoadTotal = "devpod_vscode_web_load_total",
}
