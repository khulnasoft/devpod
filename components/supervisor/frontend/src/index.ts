...
LoadingFrame.load().then(async (loading) => {
    ...
    document.title = frontendDashboardServiceClient.latestInfo.workspaceDescription ?? "devpod";
    window.devpod.loggedUserID = frontendDashboardServiceClient.latestInfo.loggedUserId;
    window.devpod.openDesktopIDE = frontendDashboardServiceClient.openDesktopIDE.bind(frontendDashboardServiceClient);
    window.devpod.decrypt = frontendDashboardServiceClient.decrypt.bind(frontendDashboardServiceClient);
    window.devpod.encrypt = frontendDashboardServiceClient.encrypt.bind(frontendDashboardServiceClient);
    window.devpod.isEncryptedData = frontendDashboardServiceClient.isEncryptedData.bind(frontendDashboardServiceClient);
    ...
    (async () => {
        ...
        //#region devpod browser telemetry
