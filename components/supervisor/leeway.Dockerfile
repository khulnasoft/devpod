...
#         would break things.
COPY components-supervisor-frontend--app/node_modules/@devpod/supervisor-frontend/dist/ /.supervisor/frontend/

WORKDIR "/.supervisor"
COPY components-supervisor--app/supervisor \
     supervisor-config.json \
     browser.sh \
     components-devpod-cli--app/devpod-cli \
     ./
...
COPY --from=docker_cli_builder /gp-docker/docker/docker /.supervisor/devpod-docker-cli
