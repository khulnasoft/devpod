	...
	return &ClientMetrics{
		...
		clientHandledHistogram: prometheus.NewHistogramVec(
			prometheus.HistogramOpts{
				...
				// it should be aligned with https://github.com/khulnasoft/devpod/blob/84ed1a0672d91446ba33cb7b504cfada769271a8/install/installer/pkg/components/ide-metrics/configmap.go#L315
