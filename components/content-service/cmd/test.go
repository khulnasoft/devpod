...
import (
	...
	"github.com/khulnasoft/devpod/content-service/api/config"
	"github.com/khulnasoft/devpod/content-service/pkg/archive"
...
var presignedDownloadCmd = &cobra.Command{
	...
	Short:   "download",
	Args:    cobra.ExactArgs(1),
	Example: "download test-owner/workspaces/test-workspace/devpod-upload",
	RunE: func(cmd *cobra.Command, args []string) error {
		presigned, err := createPresignedAccess()
		if err != nil {
			return err
...
var presignedExistsCmd = &cobra.Command{
	...
	Short:   "exists",
	Args:    cobra.ExactArgs(1),
	Example: "exists test-owner/workspaces/test-workspace/devpod-upload",
	RunE: func(cmd *cobra.Command, args []string) error {
		presigned, err := createPresignedAccess()
		if err != nil {
			return err
...
var presignedDeleteBucketCmd = &cobra.Command{
	...
	Short:   "bucket",
	Args:    cobra.ExactArgs(1),
	Example: "delete bucket devpod-s3",
	RunE: func(cmd *cobra.Command, args []string) error {
		presigned, err := createPresignedAccess()
		if err != nil {
			return err
