...
pushd "go"
  go install github.com/khulnasoft/devpod/components/public-api/go/protoc-proxy-gen
popd
...
buf breaking --against "https://github.com/khulnasoft/devpod.git#branch=main,subdir=components/public-api"
