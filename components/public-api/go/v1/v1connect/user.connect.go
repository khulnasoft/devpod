...
const (
	...
	UserServiceName = "devpod.v1.UserService"
)

// UserServiceClient is a client for the devpod.v1.UserService service.
...
// NewUserServiceClient constructs a client for the devpod.v1.UserService service. By default, it
...
func NewUserServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		getAuthenticatedUser: connect_go.NewClient[v1.GetAuthenticatedUserRequest, v1.GetAuthenticatedUserResponse](
			httpClient,
			baseURL+"/devpod.v1.UserService/GetAuthenticatedUser",
			opts...,
		),
		updateUser: connect_go.NewClient[v1.UpdateUserRequest, v1.UpdateUserResponse](
			httpClient,
			baseURL+"/devpod.v1.UserService/UpdateUser",
			opts...,
		),
...
// GetAuthenticatedUser calls devpod.v1.UserService.GetAuthenticatedUser.
...
// UpdateUser calls devpod.v1.UserService.UpdateUser.
...
// SetWorkspaceAutoStartOptions calls devpod.v1.UserService.SetWorkspaceAutoStartOptions.
...
// DeleteUser calls devpod.v1.UserService.DeleteUser.
...
// VerifyUser calls devpod.v1.UserService.VerifyUser.
...
// BlockUser calls devpod.v1.UserService.BlockUser.
...
// ListUsers calls devpod.v1.UserService.ListUsers.
...
// GetUser calls devpod.v1.UserService.GetUser.
...
// SetRolesOrPermissions calls devpod.v1.UserService.SetRolesOrPermissions.
...
// UserServiceHandler is an implementation of the devpod.v1.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.v1.UserService/GetAuthenticatedUser", connect_go.NewUnaryHandler(
		"/devpod.v1.UserService/GetAuthenticatedUser",
		svc.GetAuthenticatedUser,
		opts...,
	))
	mux.Handle("/devpod.v1.UserService/UpdateUser", connect_go.NewUnaryHandler(
		"/devpod.v1.UserService/UpdateUser",
		svc.UpdateUser,
		opts...,
	))
	mux.Handle("/devpod.v1.UserService/SetWorkspaceAutoStartOptions", connect_go.NewUnaryHandler(
		"/devpod.v1.UserService/SetWorkspaceAutoStartOptions",
		svc.SetWorkspaceAutoStartOptions,
		opts...,
	))
	mux.Handle("/devpod.v1.UserService/DeleteUser", connect_go.NewUnaryHandler(
		"/devpod.v1.UserService/DeleteUser",
		svc.DeleteUser,
		opts...,
	))
	mux.Handle("/devpod.v1.UserService/VerifyUser", connect_go.NewUnaryHandler(
		"/devpod.v1.UserService/VerifyUser",
		svc.VerifyUser,
		opts...,
	))
	mux.Handle("/devpod.v1.UserService/BlockUser", connect_go.NewUnaryHandler(
		"/devpod.v1.UserService/BlockUser",
		svc.BlockUser,
		opts...,
	))
	mux.Handle("/devpod.v1.UserService/ListUsers", connect_go.NewUnaryHandler(
		"/devpod.v1.UserService/ListUsers",
		svc.ListUsers,
		opts...,
	))
	mux.Handle("/devpod.v1.UserService/GetUser", connect_go.NewUnaryHandler(
		"/devpod.v1.UserService/GetUser",
		svc.GetUser,
		opts...,
	))
	mux.Handle("/devpod.v1.UserService/SetRolesOrPermissions", connect_go.NewUnaryHandler(
		"/devpod.v1.UserService/SetRolesOrPermissions",
		svc.SetRolesOrPermissions,
		opts...,
	))
	return "/devpod.v1.UserService/", mux
}
...
func (UnimplementedUserServiceHandler) GetAuthenticatedUser(context.Context, *connect_go.Request[v1.GetAuthenticatedUserRequest]) (*connect_go.Response[v1.GetAuthenticatedUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.UserService.GetAuthenticatedUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect_go.Request[v1.UpdateUserRequest]) (*connect_go.Response[v1.UpdateUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.UserService.UpdateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) SetWorkspaceAutoStartOptions(context.Context, *connect_go.Request[v1.SetWorkspaceAutoStartOptionsRequest]) (*connect_go.Response[v1.SetWorkspaceAutoStartOptionsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.UserService.SetWorkspaceAutoStartOptions is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect_go.Request[v1.DeleteUserRequest]) (*connect_go.Response[v1.DeleteUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.UserService.DeleteUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) VerifyUser(context.Context, *connect_go.Request[v1.VerifyUserRequest]) (*connect_go.Response[v1.VerifyUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.UserService.VerifyUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) BlockUser(context.Context, *connect_go.Request[v1.BlockUserRequest]) (*connect_go.Response[v1.BlockUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.UserService.BlockUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListUsers(context.Context, *connect_go.Request[v1.ListUsersRequest]) (*connect_go.Response[v1.ListUsersResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.UserService.ListUsers is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect_go.Request[v1.GetUserRequest]) (*connect_go.Response[v1.GetUserResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) SetRolesOrPermissions(context.Context, *connect_go.Request[v1.SetRolesOrPermissionsRequest]) (*connect_go.Response[v1.SetRolesOrPermissionsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.UserService.SetRolesOrPermissions is not implemented"))
}
