...
const (
	...
	InstallationServiceName = "devpod.v1.InstallationService"
)
...
// NewInstallationServiceClient constructs a client for the devpod.v1.InstallationService service.
...
func NewInstallationServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) InstallationServiceClient {
	...
	return &installationServiceClient{
		...
		getInstallationConfiguration: connect_go.NewClient[v1.GetInstallationConfigurationRequest, v1.GetInstallationConfigurationResponse](
			httpClient,
			baseURL+"/devpod.v1.InstallationService/GetInstallationConfiguration",
			opts...,
		),
	}
}
...
// devpod.v1.InstallationService.GetInstallationWorkspaceDefaultImage.
...
// ListBlockedRepositories calls devpod.v1.InstallationService.ListBlockedRepositories.
...
// CreateBlockedRepository calls devpod.v1.InstallationService.CreateBlockedRepository.
...
// DeleteBlockedRepository calls devpod.v1.InstallationService.DeleteBlockedRepository.
...
// ListBlockedEmailDomains calls devpod.v1.InstallationService.ListBlockedEmailDomains.
...
// CreateBlockedEmailDomain calls devpod.v1.InstallationService.CreateBlockedEmailDomain.
...
// GetOnboardingState calls devpod.v1.InstallationService.GetOnboardingState.
...
// GetInstallationConfiguration calls devpod.v1.InstallationService.GetInstallationConfiguration.
...
func NewInstallationServiceHandler(svc InstallationServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.v1.InstallationService/GetInstallationWorkspaceDefaultImage", connect_go.NewUnaryHandler(
		"/devpod.v1.InstallationService/GetInstallationWorkspaceDefaultImage",
		svc.GetInstallationWorkspaceDefaultImage,
		opts...,
	))
	mux.Handle("/devpod.v1.InstallationService/ListBlockedRepositories", connect_go.NewUnaryHandler(
		"/devpod.v1.InstallationService/ListBlockedRepositories",
		svc.ListBlockedRepositories,
		opts...,
	))
	mux.Handle("/devpod.v1.InstallationService/CreateBlockedRepository", connect_go.NewUnaryHandler(
		"/devpod.v1.InstallationService/CreateBlockedRepository",
		svc.CreateBlockedRepository,
		opts...,
	))
	mux.Handle("/devpod.v1.InstallationService/DeleteBlockedRepository", connect_go.NewUnaryHandler(
		"/devpod.v1.InstallationService/DeleteBlockedRepository",
		svc.DeleteBlockedRepository,
		opts...,
	))
	mux.Handle("/devpod.v1.InstallationService/ListBlockedEmailDomains", connect_go.NewUnaryHandler(
		"/devpod.v1.InstallationService/ListBlockedEmailDomains",
		svc.ListBlockedEmailDomains,
		opts...,
	))
	mux.Handle("/devpod.v1.InstallationService/CreateBlockedEmailDomain", connect_go.NewUnaryHandler(
		"/devpod.v1.InstallationService/CreateBlockedEmailDomain",
		svc.CreateBlockedEmailDomain,
		opts...,
	))
	mux.Handle("/devpod.v1.InstallationService/GetOnboardingState", connect_go.NewUnaryHandler(
		"/devpod.v1.InstallationService/GetOnboardingState",
		svc.GetOnboardingState,
		opts...,
	))
	mux.Handle("/devpod.v1.InstallationService/GetInstallationConfiguration", connect_go.NewUnaryHandler(
		"/devpod.v1.InstallationService/GetInstallationConfiguration",
		svc.GetInstallationConfiguration,
		opts...,
	))
	return "/devpod.v1.InstallationService/", mux
}
...
func (UnimplementedInstallationServiceHandler) GetInstallationWorkspaceDefaultImage(context.Context, *connect_go.Request[v1.GetInstallationWorkspaceDefaultImageRequest]) (*connect_go.Response[v1.GetInstallationWorkspaceDefaultImageResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.InstallationService.GetInstallationWorkspaceDefaultImage is not implemented"))
}
...
func (UnimplementedInstallationServiceHandler) ListBlockedRepositories(context.Context, *connect_go.Request[v1.ListBlockedRepositoriesRequest]) (*connect_go.Response[v1.ListBlockedRepositoriesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.InstallationService.ListBlockedRepositories is not implemented"))
}
...
func (UnimplementedInstallationServiceHandler) CreateBlockedRepository(context.Context, *connect_go.Request[v1.CreateBlockedRepositoryRequest]) (*connect_go.Response[v1.CreateBlockedRepositoryResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.InstallationService.CreateBlockedRepository is not implemented"))
}
...
func (UnimplementedInstallationServiceHandler) DeleteBlockedRepository(context.Context, *connect_go.Request[v1.DeleteBlockedRepositoryRequest]) (*connect_go.Response[v1.DeleteBlockedRepositoryResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.InstallationService.DeleteBlockedRepository is not implemented"))
}
...
func (UnimplementedInstallationServiceHandler) ListBlockedEmailDomains(context.Context, *connect_go.Request[v1.ListBlockedEmailDomainsRequest]) (*connect_go.Response[v1.ListBlockedEmailDomainsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.InstallationService.ListBlockedEmailDomains is not implemented"))
}
...
func (UnimplementedInstallationServiceHandler) CreateBlockedEmailDomain(context.Context, *connect_go.Request[v1.CreateBlockedEmailDomainRequest]) (*connect_go.Response[v1.CreateBlockedEmailDomainResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.InstallationService.CreateBlockedEmailDomain is not implemented"))
}
...
func (UnimplementedInstallationServiceHandler) GetOnboardingState(context.Context, *connect_go.Request[v1.GetOnboardingStateRequest]) (*connect_go.Response[v1.GetOnboardingStateResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.InstallationService.GetOnboardingState is not implemented"))
}
...
func (UnimplementedInstallationServiceHandler) GetInstallationConfiguration(context.Context, *connect_go.Request[v1.GetInstallationConfigurationRequest]) (*connect_go.Response[v1.GetInstallationConfigurationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.InstallationService.GetInstallationConfiguration is not implemented"))
}
