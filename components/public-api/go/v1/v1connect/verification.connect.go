...
const (
	...
	VerificationServiceName = "devpod.v1.VerificationService"
)

// VerificationServiceClient is a client for the devpod.v1.VerificationService service.
...
// NewVerificationServiceClient constructs a client for the devpod.v1.VerificationService service.
...
func NewVerificationServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) VerificationServiceClient {
	...
	return &verificationServiceClient{
		sendPhoneNumberVerificationToken: connect_go.NewClient[v1.SendPhoneNumberVerificationTokenRequest, v1.SendPhoneNumberVerificationTokenResponse](
			httpClient,
			baseURL+"/devpod.v1.VerificationService/SendPhoneNumberVerificationToken",
			opts...,
		),
		verifyPhoneNumberVerificationToken: connect_go.NewClient[v1.VerifyPhoneNumberVerificationTokenRequest, v1.VerifyPhoneNumberVerificationTokenResponse](
			httpClient,
			baseURL+"/devpod.v1.VerificationService/VerifyPhoneNumberVerificationToken",
			opts...,
		),
	}
}
...
// devpod.v1.VerificationService.SendPhoneNumberVerificationToken.
...
// devpod.v1.VerificationService.VerifyPhoneNumberVerificationToken.
...
// VerificationServiceHandler is an implementation of the devpod.v1.VerificationService service.
...
func NewVerificationServiceHandler(svc VerificationServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.v1.VerificationService/SendPhoneNumberVerificationToken", connect_go.NewUnaryHandler(
		"/devpod.v1.VerificationService/SendPhoneNumberVerificationToken",
		svc.SendPhoneNumberVerificationToken,
		opts...,
	))
	mux.Handle("/devpod.v1.VerificationService/VerifyPhoneNumberVerificationToken", connect_go.NewUnaryHandler(
		"/devpod.v1.VerificationService/VerifyPhoneNumberVerificationToken",
		svc.VerifyPhoneNumberVerificationToken,
		opts...,
	))
	return "/devpod.v1.VerificationService/", mux
}
...
func (UnimplementedVerificationServiceHandler) SendPhoneNumberVerificationToken(context.Context, *connect_go.Request[v1.SendPhoneNumberVerificationTokenRequest]) (*connect_go.Response[v1.SendPhoneNumberVerificationTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.VerificationService.SendPhoneNumberVerificationToken is not implemented"))
}
...
func (UnimplementedVerificationServiceHandler) VerifyPhoneNumberVerificationToken(context.Context, *connect_go.Request[v1.VerifyPhoneNumberVerificationTokenRequest]) (*connect_go.Response[v1.VerifyPhoneNumberVerificationTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.VerificationService.VerifyPhoneNumberVerificationToken is not implemented"))
}
