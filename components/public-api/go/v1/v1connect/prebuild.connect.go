...
const (
	...
	PrebuildServiceName = "devpod.v1.PrebuildService"
)

// PrebuildServiceClient is a client for the devpod.v1.PrebuildService service.
...
// NewPrebuildServiceClient constructs a client for the devpod.v1.PrebuildService service. By
...
// StartPrebuild calls devpod.v1.PrebuildService.StartPrebuild.
...
// CancelPrebuild calls devpod.v1.PrebuildService.CancelPrebuild.
...
// GetPrebuild calls devpod.v1.PrebuildService.GetPrebuild.
...
// ListPrebuilds calls devpod.v1.PrebuildService.ListPrebuilds.
...
// WatchPrebuild calls devpod.v1.PrebuildService.WatchPrebuild.
...
// ListOrganizationPrebuilds calls devpod.v1.PrebuildService.ListOrganizationPrebuilds.
...
// PrebuildServiceHandler is an implementation of the devpod.v1.PrebuildService service.
...
func NewPrebuildServiceHandler(svc PrebuildServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.v1.PrebuildService/StartPrebuild", connect_go.NewUnaryHandler(
		"/devpod.v1.PrebuildService/StartPrebuild",
		svc.StartPrebuild,
		opts...,
	))
	mux.Handle("/devpod.v1.PrebuildService/CancelPrebuild", connect_go.NewUnaryHandler(
		"/devpod.v1.PrebuildService/CancelPrebuild",
		svc.CancelPrebuild,
		opts...,
	))
	mux.Handle("/devpod.v1.PrebuildService/GetPrebuild", connect_go.NewUnaryHandler(
		"/devpod.v1.PrebuildService/GetPrebuild",
		svc.GetPrebuild,
		opts...,
	))
	mux.Handle("/devpod.v1.PrebuildService/ListPrebuilds", connect_go.NewUnaryHandler(
		"/devpod.v1.PrebuildService/ListPrebuilds",
		svc.ListPrebuilds,
		opts...,
	))
	mux.Handle("/devpod.v1.PrebuildService/WatchPrebuild", connect_go.NewServerStreamHandler(
		"/devpod.v1.PrebuildService/WatchPrebuild",
		svc.WatchPrebuild,
		opts...,
	))
	mux.Handle("/devpod.v1.PrebuildService/ListOrganizationPrebuilds", connect_go.NewUnaryHandler(
		"/devpod.v1.PrebuildService/ListOrganizationPrebuilds",
		svc.ListOrganizationPrebuilds,
		opts...,
	))
	return "/devpod.v1.PrebuildService/", mux
}
...
func (UnimplementedPrebuildServiceHandler) StartPrebuild(context.Context, *connect_go.Request[v1.StartPrebuildRequest]) (*connect_go.Response[v1.StartPrebuildResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.PrebuildService.StartPrebuild is not implemented"))
}
...
func (UnimplementedPrebuildServiceHandler) CancelPrebuild(context.Context, *connect_go.Request[v1.CancelPrebuildRequest]) (*connect_go.Response[v1.CancelPrebuildResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.PrebuildService.CancelPrebuild is not implemented"))
}
...
func (UnimplementedPrebuildServiceHandler) GetPrebuild(context.Context, *connect_go.Request[v1.GetPrebuildRequest]) (*connect_go.Response[v1.GetPrebuildResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.PrebuildService.GetPrebuild is not implemented"))
}
...
func (UnimplementedPrebuildServiceHandler) ListPrebuilds(context.Context, *connect_go.Request[v1.ListPrebuildsRequest]) (*connect_go.Response[v1.ListPrebuildsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.PrebuildService.ListPrebuilds is not implemented"))
}
...
func (UnimplementedPrebuildServiceHandler) WatchPrebuild(context.Context, *connect_go.Request[v1.WatchPrebuildRequest], *connect_go.ServerStream[v1.WatchPrebuildResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.PrebuildService.WatchPrebuild is not implemented"))
}
...
func (UnimplementedPrebuildServiceHandler) ListOrganizationPrebuilds(context.Context, *connect_go.Request[v1.ListOrganizationPrebuildsRequest]) (*connect_go.Response[v1.ListOrganizationPrebuildsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.PrebuildService.ListOrganizationPrebuilds is not implemented"))
}
