...
const (
	...
	AuthProviderServiceName = "devpod.v1.AuthProviderService"
)

// AuthProviderServiceClient is a client for the devpod.v1.AuthProviderService service.
...
// NewAuthProviderServiceClient constructs a client for the devpod.v1.AuthProviderService service.
...
// CreateAuthProvider calls devpod.v1.AuthProviderService.CreateAuthProvider.
...
// GetAuthProvider calls devpod.v1.AuthProviderService.GetAuthProvider.
...
// ListAuthProviders calls devpod.v1.AuthProviderService.ListAuthProviders.
...
// ListAuthProviderDescriptions calls devpod.v1.AuthProviderService.ListAuthProviderDescriptions.
...
// UpdateAuthProvider calls devpod.v1.AuthProviderService.UpdateAuthProvider.
...
// DeleteAuthProvider calls devpod.v1.AuthProviderService.DeleteAuthProvider.
...
// AuthProviderServiceHandler is an implementation of the devpod.v1.AuthProviderService service.
...
func NewAuthProviderServiceHandler(svc AuthProviderServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.v1.AuthProviderService/CreateAuthProvider", connect_go.NewUnaryHandler(
		"/devpod.v1.AuthProviderService/CreateAuthProvider",
		svc.CreateAuthProvider,
		opts...,
	))
	mux.Handle("/devpod.v1.AuthProviderService/GetAuthProvider", connect_go.NewUnaryHandler(
		"/devpod.v1.AuthProviderService/GetAuthProvider",
		svc.GetAuthProvider,
		opts...,
	))
	mux.Handle("/devpod.v1.AuthProviderService/ListAuthProviders", connect_go.NewUnaryHandler(
		"/devpod.v1.AuthProviderService/ListAuthProviders",
		svc.ListAuthProviders,
		opts...,
	))
	mux.Handle("/devpod.v1.AuthProviderService/ListAuthProviderDescriptions", connect_go.NewUnaryHandler(
		"/devpod.v1.AuthProviderService/ListAuthProviderDescriptions",
		svc.ListAuthProviderDescriptions,
		opts...,
	))
	mux.Handle("/devpod.v1.AuthProviderService/UpdateAuthProvider", connect_go.NewUnaryHandler(
		"/devpod.v1.AuthProviderService/UpdateAuthProvider",
		svc.UpdateAuthProvider,
		opts...,
	))
	mux.Handle("/devpod.v1.AuthProviderService/DeleteAuthProvider", connect_go.NewUnaryHandler(
		"/devpod.v1.AuthProviderService/DeleteAuthProvider",
		svc.DeleteAuthProvider,
		opts...,
	))
	return "/devpod.v1.AuthProviderService/", mux
}
...
func (UnimplementedAuthProviderServiceHandler) CreateAuthProvider(context.Context, *connect_go.Request[v1.CreateAuthProviderRequest]) (*connect_go.Response[v1.CreateAuthProviderResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.AuthProviderService.CreateAuthProvider is not implemented"))
}
...
func (UnimplementedAuthProviderServiceHandler) GetAuthProvider(context.Context, *connect_go.Request[v1.GetAuthProviderRequest]) (*connect_go.Response[v1.GetAuthProviderResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.AuthProviderService.GetAuthProvider is not implemented"))
}
...
func (UnimplementedAuthProviderServiceHandler) ListAuthProviders(context.Context, *connect_go.Request[v1.ListAuthProvidersRequest]) (*connect_go.Response[v1.ListAuthProvidersResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.AuthProviderService.ListAuthProviders is not implemented"))
}
...
func (UnimplementedAuthProviderServiceHandler) ListAuthProviderDescriptions(context.Context, *connect_go.Request[v1.ListAuthProviderDescriptionsRequest]) (*connect_go.Response[v1.ListAuthProviderDescriptionsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.AuthProviderService.ListAuthProviderDescriptions is not implemented"))
}
...
func (UnimplementedAuthProviderServiceHandler) UpdateAuthProvider(context.Context, *connect_go.Request[v1.UpdateAuthProviderRequest]) (*connect_go.Response[v1.UpdateAuthProviderResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.AuthProviderService.UpdateAuthProvider is not implemented"))
}
...
func (UnimplementedAuthProviderServiceHandler) DeleteAuthProvider(context.Context, *connect_go.Request[v1.DeleteAuthProviderRequest]) (*connect_go.Response[v1.DeleteAuthProviderResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.AuthProviderService.DeleteAuthProvider is not implemented"))
}
