...
const (
	...
	SCMServiceName = "devpod.v1.SCMService"
)

// SCMServiceClient is a client for the devpod.v1.SCMService service.
...
// NewSCMServiceClient constructs a client for the devpod.v1.SCMService service. By default, it uses
...
// SearchSCMTokens calls devpod.v1.SCMService.SearchSCMTokens.
...
// GuessTokenScopes calls devpod.v1.SCMService.GuessTokenScopes.
...
// SearchRepositories calls devpod.v1.SCMService.SearchRepositories.
...
// ListSuggestedRepositories calls devpod.v1.SCMService.ListSuggestedRepositories.
...
// SCMServiceHandler is an implementation of the devpod.v1.SCMService service.
...
func NewSCMServiceHandler(svc SCMServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.v1.SCMService/SearchSCMTokens", connect_go.NewUnaryHandler(
		"/devpod.v1.SCMService/SearchSCMTokens",
		svc.SearchSCMTokens,
		opts...,
	))
	mux.Handle("/devpod.v1.SCMService/GuessTokenScopes", connect_go.NewUnaryHandler(
		"/devpod.v1.SCMService/GuessTokenScopes",
		svc.GuessTokenScopes,
		opts...,
	))
	mux.Handle("/devpod.v1.SCMService/SearchRepositories", connect_go.NewUnaryHandler(
		"/devpod.v1.SCMService/SearchRepositories",
		svc.SearchRepositories,
		opts...,
	))
	mux.Handle("/devpod.v1.SCMService/ListSuggestedRepositories", connect_go.NewUnaryHandler(
		"/devpod.v1.SCMService/ListSuggestedRepositories",
		svc.ListSuggestedRepositories,
		opts...,
	))
	return "/devpod.v1.SCMService/", mux
}
...
func (UnimplementedSCMServiceHandler) SearchSCMTokens(context.Context, *connect_go.Request[v1.SearchSCMTokensRequest]) (*connect_go.Response[v1.SearchSCMTokensResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.SCMService.SearchSCMTokens is not implemented"))
}
...
func (UnimplementedSCMServiceHandler) GuessTokenScopes(context.Context, *connect_go.Request[v1.GuessTokenScopesRequest]) (*connect_go.Response[v1.GuessTokenScopesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.SCMService.GuessTokenScopes is not implemented"))
}
...
func (UnimplementedSCMServiceHandler) SearchRepositories(context.Context, *connect_go.Request[v1.SearchRepositoriesRequest]) (*connect_go.Response[v1.SearchRepositoriesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.SCMService.SearchRepositories is not implemented"))
}
...
func (UnimplementedSCMServiceHandler) ListSuggestedRepositories(context.Context, *connect_go.Request[v1.ListSuggestedRepositoriesRequest]) (*connect_go.Response[v1.ListSuggestedRepositoriesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.SCMService.ListSuggestedRepositories is not implemented"))
}
