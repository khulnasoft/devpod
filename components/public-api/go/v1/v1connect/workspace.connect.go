...
const (
	...
	WorkspaceServiceName = "devpod.v1.WorkspaceService"
)

// WorkspaceServiceClient is a client for the devpod.v1.WorkspaceService service.
...
// NewWorkspaceServiceClient constructs a client for the devpod.v1.WorkspaceService service. By
...
// GetWorkspace calls devpod.v1.WorkspaceService.GetWorkspace.
...
// WatchWorkspaceStatus calls devpod.v1.WorkspaceService.WatchWorkspaceStatus.
...
// ListWorkspaces calls devpod.v1.WorkspaceService.ListWorkspaces.
...
// ListWorkspaceSessions calls devpod.v1.WorkspaceService.ListWorkspaceSessions.
...
// CreateAndStartWorkspace calls devpod.v1.WorkspaceService.CreateAndStartWorkspace.
...
// StartWorkspace calls devpod.v1.WorkspaceService.StartWorkspace.
...
// UpdateWorkspace calls devpod.v1.WorkspaceService.UpdateWorkspace.
...
// StopWorkspace calls devpod.v1.WorkspaceService.StopWorkspace.
...
// DeleteWorkspace calls devpod.v1.WorkspaceService.DeleteWorkspace.
...
// ListWorkspaceClasses calls devpod.v1.WorkspaceService.ListWorkspaceClasses.
...
// ParseContextURL calls devpod.v1.WorkspaceService.ParseContextURL.
...
// GetWorkspaceDefaultImage calls devpod.v1.WorkspaceService.GetWorkspaceDefaultImage.
...
// SendHeartBeat calls devpod.v1.WorkspaceService.SendHeartBeat.
...
// GetWorkspaceOwnerToken calls devpod.v1.WorkspaceService.GetWorkspaceOwnerToken.
...
// GetWorkspaceEditorCredentials calls devpod.v1.WorkspaceService.GetWorkspaceEditorCredentials.
...
// CreateWorkspaceSnapshot calls devpod.v1.WorkspaceService.CreateWorkspaceSnapshot.
...
// WaitForWorkspaceSnapshot calls devpod.v1.WorkspaceService.WaitForWorkspaceSnapshot.
...
// UpdateWorkspacePort calls devpod.v1.WorkspaceService.UpdateWorkspacePort.
...
// WorkspaceServiceHandler is an implementation of the devpod.v1.WorkspaceService service.
...
func NewWorkspaceServiceHandler(svc WorkspaceServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.v1.WorkspaceService/GetWorkspace", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/GetWorkspace",
		svc.GetWorkspace,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/WatchWorkspaceStatus", connect_go.NewServerStreamHandler(
		"/devpod.v1.WorkspaceService/WatchWorkspaceStatus",
		svc.WatchWorkspaceStatus,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/ListWorkspaces", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/ListWorkspaces",
		svc.ListWorkspaces,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/ListWorkspaceSessions", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/ListWorkspaceSessions",
		svc.ListWorkspaceSessions,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/CreateAndStartWorkspace", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/CreateAndStartWorkspace",
		svc.CreateAndStartWorkspace,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/StartWorkspace", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/StartWorkspace",
		svc.StartWorkspace,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/UpdateWorkspace", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/UpdateWorkspace",
		svc.UpdateWorkspace,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/StopWorkspace", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/StopWorkspace",
		svc.StopWorkspace,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/DeleteWorkspace", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/DeleteWorkspace",
		svc.DeleteWorkspace,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/ListWorkspaceClasses", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/ListWorkspaceClasses",
		svc.ListWorkspaceClasses,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/ParseContextURL", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/ParseContextURL",
		svc.ParseContextURL,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/GetWorkspaceDefaultImage", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/GetWorkspaceDefaultImage",
		svc.GetWorkspaceDefaultImage,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/SendHeartBeat", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/SendHeartBeat",
		svc.SendHeartBeat,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/GetWorkspaceOwnerToken", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/GetWorkspaceOwnerToken",
		svc.GetWorkspaceOwnerToken,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/GetWorkspaceEditorCredentials", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/GetWorkspaceEditorCredentials",
		svc.GetWorkspaceEditorCredentials,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/CreateWorkspaceSnapshot", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/CreateWorkspaceSnapshot",
		svc.CreateWorkspaceSnapshot,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/WaitForWorkspaceSnapshot", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/WaitForWorkspaceSnapshot",
		svc.WaitForWorkspaceSnapshot,
		opts...,
	))
	mux.Handle("/devpod.v1.WorkspaceService/UpdateWorkspacePort", connect_go.NewUnaryHandler(
		"/devpod.v1.WorkspaceService/UpdateWorkspacePort",
		svc.UpdateWorkspacePort,
		opts...,
	))
	return "/devpod.v1.WorkspaceService/", mux
}
...
func (UnimplementedWorkspaceServiceHandler) GetWorkspace(context.Context, *connect_go.Request[v1.GetWorkspaceRequest]) (*connect_go.Response[v1.GetWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.GetWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) WatchWorkspaceStatus(context.Context, *connect_go.Request[v1.WatchWorkspaceStatusRequest], *connect_go.ServerStream[v1.WatchWorkspaceStatusResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.WatchWorkspaceStatus is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) ListWorkspaces(context.Context, *connect_go.Request[v1.ListWorkspacesRequest]) (*connect_go.Response[v1.ListWorkspacesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.ListWorkspaces is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) ListWorkspaceSessions(context.Context, *connect_go.Request[v1.ListWorkspaceSessionsRequest]) (*connect_go.Response[v1.ListWorkspaceSessionsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.ListWorkspaceSessions is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) CreateAndStartWorkspace(context.Context, *connect_go.Request[v1.CreateAndStartWorkspaceRequest]) (*connect_go.Response[v1.CreateAndStartWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.CreateAndStartWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) StartWorkspace(context.Context, *connect_go.Request[v1.StartWorkspaceRequest]) (*connect_go.Response[v1.StartWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.StartWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) UpdateWorkspace(context.Context, *connect_go.Request[v1.UpdateWorkspaceRequest]) (*connect_go.Response[v1.UpdateWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.UpdateWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) StopWorkspace(context.Context, *connect_go.Request[v1.StopWorkspaceRequest]) (*connect_go.Response[v1.StopWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.StopWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) DeleteWorkspace(context.Context, *connect_go.Request[v1.DeleteWorkspaceRequest]) (*connect_go.Response[v1.DeleteWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.DeleteWorkspace is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) ListWorkspaceClasses(context.Context, *connect_go.Request[v1.ListWorkspaceClassesRequest]) (*connect_go.Response[v1.ListWorkspaceClassesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.ListWorkspaceClasses is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) ParseContextURL(context.Context, *connect_go.Request[v1.ParseContextURLRequest]) (*connect_go.Response[v1.ParseContextURLResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.ParseContextURL is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) GetWorkspaceDefaultImage(context.Context, *connect_go.Request[v1.GetWorkspaceDefaultImageRequest]) (*connect_go.Response[v1.GetWorkspaceDefaultImageResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.GetWorkspaceDefaultImage is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) SendHeartBeat(context.Context, *connect_go.Request[v1.SendHeartBeatRequest]) (*connect_go.Response[v1.SendHeartBeatResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.SendHeartBeat is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) GetWorkspaceOwnerToken(context.Context, *connect_go.Request[v1.GetWorkspaceOwnerTokenRequest]) (*connect_go.Response[v1.GetWorkspaceOwnerTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.GetWorkspaceOwnerToken is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) GetWorkspaceEditorCredentials(context.Context, *connect_go.Request[v1.GetWorkspaceEditorCredentialsRequest]) (*connect_go.Response[v1.GetWorkspaceEditorCredentialsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.GetWorkspaceEditorCredentials is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) CreateWorkspaceSnapshot(context.Context, *connect_go.Request[v1.CreateWorkspaceSnapshotRequest]) (*connect_go.Response[v1.CreateWorkspaceSnapshotResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.CreateWorkspaceSnapshot is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) WaitForWorkspaceSnapshot(context.Context, *connect_go.Request[v1.WaitForWorkspaceSnapshotRequest]) (*connect_go.Response[v1.WaitForWorkspaceSnapshotResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.WaitForWorkspaceSnapshot is not implemented"))
}
...
func (UnimplementedWorkspaceServiceHandler) UpdateWorkspacePort(context.Context, *connect_go.Request[v1.UpdateWorkspacePortRequest]) (*connect_go.Response[v1.UpdateWorkspacePortResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.WorkspaceService.UpdateWorkspacePort is not implemented"))
}
