...
const (
	...
	OrganizationServiceName = "devpod.v1.OrganizationService"
)

// OrganizationServiceClient is a client for the devpod.v1.OrganizationService service.
...
// NewOrganizationServiceClient constructs a client for the devpod.v1.OrganizationService service.
...
func NewOrganizationServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) OrganizationServiceClient {
	...
	return &organizationServiceClient{
		...
		updateOrganizationSettings: connect_go.NewClient[v1.UpdateOrganizationSettingsRequest, v1.UpdateOrganizationSettingsResponse](
			httpClient,
			baseURL+"/devpod.v1.OrganizationService/UpdateOrganizationSettings",
			opts...,
		),
		listOrganizationWorkspaceClasses: connect_go.NewClient[v1.ListOrganizationWorkspaceClassesRequest, v1.ListOrganizationWorkspaceClassesResponse](
			httpClient,
			baseURL+"/devpod.v1.OrganizationService/ListOrganizationWorkspaceClasses",
			opts...,
		),
	}
}
...
// CreateOrganization calls devpod.v1.OrganizationService.CreateOrganization.
...
// GetOrganization calls devpod.v1.OrganizationService.GetOrganization.
...
// UpdateOrganization calls devpod.v1.OrganizationService.UpdateOrganization.
...
// ListOrganizations calls devpod.v1.OrganizationService.ListOrganizations.
...
// DeleteOrganization calls devpod.v1.OrganizationService.DeleteOrganization.
...
// GetOrganizationInvitation calls devpod.v1.OrganizationService.GetOrganizationInvitation.
...
// JoinOrganization calls devpod.v1.OrganizationService.JoinOrganization.
...
// ResetOrganizationInvitation calls devpod.v1.OrganizationService.ResetOrganizationInvitation.
...
// ListOrganizationMembers calls devpod.v1.OrganizationService.ListOrganizationMembers.
...
// UpdateOrganizationMember calls devpod.v1.OrganizationService.UpdateOrganizationMember.
...
// DeleteOrganizationMember calls devpod.v1.OrganizationService.DeleteOrganizationMember.
...
// GetOrganizationSettings calls devpod.v1.OrganizationService.GetOrganizationSettings.
...
// UpdateOrganizationSettings calls devpod.v1.OrganizationService.UpdateOrganizationSettings.
...
// devpod.v1.OrganizationService.ListOrganizationWorkspaceClasses.
...
// OrganizationServiceHandler is an implementation of the devpod.v1.OrganizationService service.
...
func NewOrganizationServiceHandler(svc OrganizationServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.v1.OrganizationService/CreateOrganization", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/CreateOrganization",
		svc.CreateOrganization,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/GetOrganization", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/GetOrganization",
		svc.GetOrganization,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/UpdateOrganization", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/UpdateOrganization",
		svc.UpdateOrganization,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/ListOrganizations", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/ListOrganizations",
		svc.ListOrganizations,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/DeleteOrganization", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/DeleteOrganization",
		svc.DeleteOrganization,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/GetOrganizationInvitation", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/GetOrganizationInvitation",
		svc.GetOrganizationInvitation,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/JoinOrganization", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/JoinOrganization",
		svc.JoinOrganization,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/ResetOrganizationInvitation", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/ResetOrganizationInvitation",
		svc.ResetOrganizationInvitation,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/ListOrganizationMembers", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/ListOrganizationMembers",
		svc.ListOrganizationMembers,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/UpdateOrganizationMember", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/UpdateOrganizationMember",
		svc.UpdateOrganizationMember,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/DeleteOrganizationMember", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/DeleteOrganizationMember",
		svc.DeleteOrganizationMember,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/GetOrganizationSettings", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/GetOrganizationSettings",
		svc.GetOrganizationSettings,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/UpdateOrganizationSettings", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/UpdateOrganizationSettings",
		svc.UpdateOrganizationSettings,
		opts...,
	))
	mux.Handle("/devpod.v1.OrganizationService/ListOrganizationWorkspaceClasses", connect_go.NewUnaryHandler(
		"/devpod.v1.OrganizationService/ListOrganizationWorkspaceClasses",
		svc.ListOrganizationWorkspaceClasses,
		opts...,
	))
	return "/devpod.v1.OrganizationService/", mux
}
...
func (UnimplementedOrganizationServiceHandler) CreateOrganization(context.Context, *connect_go.Request[v1.CreateOrganizationRequest]) (*connect_go.Response[v1.CreateOrganizationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.CreateOrganization is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) GetOrganization(context.Context, *connect_go.Request[v1.GetOrganizationRequest]) (*connect_go.Response[v1.GetOrganizationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.GetOrganization is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) UpdateOrganization(context.Context, *connect_go.Request[v1.UpdateOrganizationRequest]) (*connect_go.Response[v1.UpdateOrganizationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.UpdateOrganization is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) ListOrganizations(context.Context, *connect_go.Request[v1.ListOrganizationsRequest]) (*connect_go.Response[v1.ListOrganizationsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.ListOrganizations is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) DeleteOrganization(context.Context, *connect_go.Request[v1.DeleteOrganizationRequest]) (*connect_go.Response[v1.DeleteOrganizationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.DeleteOrganization is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) GetOrganizationInvitation(context.Context, *connect_go.Request[v1.GetOrganizationInvitationRequest]) (*connect_go.Response[v1.GetOrganizationInvitationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.GetOrganizationInvitation is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) JoinOrganization(context.Context, *connect_go.Request[v1.JoinOrganizationRequest]) (*connect_go.Response[v1.JoinOrganizationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.JoinOrganization is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) ResetOrganizationInvitation(context.Context, *connect_go.Request[v1.ResetOrganizationInvitationRequest]) (*connect_go.Response[v1.ResetOrganizationInvitationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.ResetOrganizationInvitation is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) ListOrganizationMembers(context.Context, *connect_go.Request[v1.ListOrganizationMembersRequest]) (*connect_go.Response[v1.ListOrganizationMembersResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.ListOrganizationMembers is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) UpdateOrganizationMember(context.Context, *connect_go.Request[v1.UpdateOrganizationMemberRequest]) (*connect_go.Response[v1.UpdateOrganizationMemberResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.UpdateOrganizationMember is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) DeleteOrganizationMember(context.Context, *connect_go.Request[v1.DeleteOrganizationMemberRequest]) (*connect_go.Response[v1.DeleteOrganizationMemberResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.DeleteOrganizationMember is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) GetOrganizationSettings(context.Context, *connect_go.Request[v1.GetOrganizationSettingsRequest]) (*connect_go.Response[v1.GetOrganizationSettingsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.GetOrganizationSettings is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) UpdateOrganizationSettings(context.Context, *connect_go.Request[v1.UpdateOrganizationSettingsRequest]) (*connect_go.Response[v1.UpdateOrganizationSettingsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.UpdateOrganizationSettings is not implemented"))
}
...
func (UnimplementedOrganizationServiceHandler) ListOrganizationWorkspaceClasses(context.Context, *connect_go.Request[v1.ListOrganizationWorkspaceClassesRequest]) (*connect_go.Response[v1.ListOrganizationWorkspaceClassesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.OrganizationService.ListOrganizationWorkspaceClasses is not implemented"))
}
