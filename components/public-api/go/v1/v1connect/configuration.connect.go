...
const (
	...
	ConfigurationServiceName = "devpod.v1.ConfigurationService"
)

// ConfigurationServiceClient is a client for the devpod.v1.ConfigurationService service.
...
// NewConfigurationServiceClient constructs a client for the devpod.v1.ConfigurationService service.
...
// CreateConfiguration calls devpod.v1.ConfigurationService.CreateConfiguration.
...
// GetConfiguration calls devpod.v1.ConfigurationService.GetConfiguration.
...
// ListConfigurations calls devpod.v1.ConfigurationService.ListConfigurations.
...
// UpdateConfiguration calls devpod.v1.ConfigurationService.UpdateConfiguration.
...
// DeleteConfiguration calls devpod.v1.ConfigurationService.DeleteConfiguration.
...
// ConfigurationServiceHandler is an implementation of the devpod.v1.ConfigurationService service.
...
func NewConfigurationServiceHandler(svc ConfigurationServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.v1.ConfigurationService/CreateConfiguration", connect_go.NewUnaryHandler(
		"/devpod.v1.ConfigurationService/CreateConfiguration",
		svc.CreateConfiguration,
		opts...,
	))
	mux.Handle("/devpod.v1.ConfigurationService/GetConfiguration", connect_go.NewUnaryHandler(
		"/devpod.v1.ConfigurationService/GetConfiguration",
		svc.GetConfiguration,
		opts...,
	))
	mux.Handle("/devpod.v1.ConfigurationService/ListConfigurations", connect_go.NewUnaryHandler(
		"/devpod.v1.ConfigurationService/ListConfigurations",
		svc.ListConfigurations,
		opts...,
	))
	mux.Handle("/devpod.v1.ConfigurationService/UpdateConfiguration", connect_go.NewUnaryHandler(
		"/devpod.v1.ConfigurationService/UpdateConfiguration",
		svc.UpdateConfiguration,
		opts...,
	))
	mux.Handle("/devpod.v1.ConfigurationService/DeleteConfiguration", connect_go.NewUnaryHandler(
		"/devpod.v1.ConfigurationService/DeleteConfiguration",
		svc.DeleteConfiguration,
		opts...,
	))
	return "/devpod.v1.ConfigurationService/", mux
}
...
func (UnimplementedConfigurationServiceHandler) CreateConfiguration(context.Context, *connect_go.Request[v1.CreateConfigurationRequest]) (*connect_go.Response[v1.CreateConfigurationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.ConfigurationService.CreateConfiguration is not implemented"))
}
...
func (UnimplementedConfigurationServiceHandler) GetConfiguration(context.Context, *connect_go.Request[v1.GetConfigurationRequest]) (*connect_go.Response[v1.GetConfigurationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.ConfigurationService.GetConfiguration is not implemented"))
}
...
func (UnimplementedConfigurationServiceHandler) ListConfigurations(context.Context, *connect_go.Request[v1.ListConfigurationsRequest]) (*connect_go.Response[v1.ListConfigurationsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.ConfigurationService.ListConfigurations is not implemented"))
}
...
func (UnimplementedConfigurationServiceHandler) UpdateConfiguration(context.Context, *connect_go.Request[v1.UpdateConfigurationRequest]) (*connect_go.Response[v1.UpdateConfigurationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.ConfigurationService.UpdateConfiguration is not implemented"))
}
...
func (UnimplementedConfigurationServiceHandler) DeleteConfiguration(context.Context, *connect_go.Request[v1.DeleteConfigurationRequest]) (*connect_go.Response[v1.DeleteConfigurationResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.ConfigurationService.DeleteConfiguration is not implemented"))
}
