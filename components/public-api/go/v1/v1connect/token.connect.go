...
const (
	...
	TokenServiceName = "devpod.v1.TokenService"
)

// TokenServiceClient is a client for the devpod.v1.TokenService service.
...
// NewTokenServiceClient constructs a client for the devpod.v1.TokenService service. By default, it
...
func NewTokenServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) TokenServiceClient {
	...
	return &tokenServiceClient{
		createTemporaryAccessToken: connect_go.NewClient[v1.CreateTemporaryAccessTokenRequest, v1.CreateTemporaryAccessTokenResponse](
			httpClient,
			baseURL+"/devpod.v1.TokenService/CreateTemporaryAccessToken",
			opts...,
		),
	}
}
...
// CreateTemporaryAccessToken calls devpod.v1.TokenService.CreateTemporaryAccessToken.
...
// TokenServiceHandler is an implementation of the devpod.v1.TokenService service.
...
func NewTokenServiceHandler(svc TokenServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.v1.TokenService/CreateTemporaryAccessToken", connect_go.NewUnaryHandler(
		"/devpod.v1.TokenService/CreateTemporaryAccessToken",
		svc.CreateTemporaryAccessToken,
		opts...,
	))
	return "/devpod.v1.TokenService/", mux
}
...
func (UnimplementedTokenServiceHandler) CreateTemporaryAccessToken(context.Context, *connect_go.Request[v1.CreateTemporaryAccessTokenRequest]) (*connect_go.Response[v1.CreateTemporaryAccessTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.v1.TokenService.CreateTemporaryAccessToken is not implemented"))
}
