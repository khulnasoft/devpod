...
func (x *SSHPublicKey) Reset() {
	*x = SSHPublicKey{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_ssh_proto_msgTypes[0]
...
func (*SSHPublicKey) Descriptor() ([]byte, []int) {
	return file_devpod_v1_ssh_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListSSHPublicKeysRequest) Reset() {
	*x = ListSSHPublicKeysRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_ssh_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListSSHPublicKeysRequest) Descriptor() ([]byte, []int) {
	return file_devpod_v1_ssh_proto_rawDescGZIP(), []int{1}
}
...
func (x *ListSSHPublicKeysResponse) Reset() {
	*x = ListSSHPublicKeysResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_ssh_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListSSHPublicKeysResponse) Descriptor() ([]byte, []int) {
	return file_devpod_v1_ssh_proto_rawDescGZIP(), []int{2}
}
...
func (x *CreateSSHPublicKeyRequest) Reset() {
	*x = CreateSSHPublicKeyRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_ssh_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateSSHPublicKeyRequest) Descriptor() ([]byte, []int) {
	return file_devpod_v1_ssh_proto_rawDescGZIP(), []int{3}
}
...
func (x *CreateSSHPublicKeyResponse) Reset() {
	*x = CreateSSHPublicKeyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_ssh_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateSSHPublicKeyResponse) Descriptor() ([]byte, []int) {
	return file_devpod_v1_ssh_proto_rawDescGZIP(), []int{4}
}
...
func (x *DeleteSSHPublicKeyRequest) Reset() {
	*x = DeleteSSHPublicKeyRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_ssh_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteSSHPublicKeyRequest) Descriptor() ([]byte, []int) {
	return file_devpod_v1_ssh_proto_rawDescGZIP(), []int{5}
}
...
func (x *DeleteSSHPublicKeyResponse) Reset() {
	*x = DeleteSSHPublicKeyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_ssh_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteSSHPublicKeyResponse) Descriptor() ([]byte, []int) {
	return file_devpod_v1_ssh_proto_rawDescGZIP(), []int{6}
}

var File_devpod_v1_ssh_proto protoreflect.FileDescriptor

var file_devpod_v1_ssh_proto_rawDesc = []byte{
...
var (
	file_devpod_v1_ssh_proto_rawDescOnce sync.Once
	file_devpod_v1_ssh_proto_rawDescData = file_devpod_v1_ssh_proto_rawDesc
)

func file_devpod_v1_ssh_proto_rawDescGZIP() []byte {
	file_devpod_v1_ssh_proto_rawDescOnce.Do(func() {
		file_devpod_v1_ssh_proto_rawDescData = protoimpl.X.CompressGZIP(file_devpod_v1_ssh_proto_rawDescData)
	})
	return file_devpod_v1_ssh_proto_rawDescData
}

var file_devpod_v1_ssh_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_devpod_v1_ssh_proto_goTypes = []interface{}{
	(*SSHPublicKey)(nil),               // 0: devpod.v1.SSHPublicKey
	(*ListSSHPublicKeysRequest)(nil),   // 1: devpod.v1.ListSSHPublicKeysRequest
	(*ListSSHPublicKeysResponse)(nil),  // 2: devpod.v1.ListSSHPublicKeysResponse
	(*CreateSSHPublicKeyRequest)(nil),  // 3: devpod.v1.CreateSSHPublicKeyRequest
	(*CreateSSHPublicKeyResponse)(nil), // 4: devpod.v1.CreateSSHPublicKeyResponse
	(*DeleteSSHPublicKeyRequest)(nil),  // 5: devpod.v1.DeleteSSHPublicKeyRequest
	(*DeleteSSHPublicKeyResponse)(nil), // 6: devpod.v1.DeleteSSHPublicKeyResponse
	(*timestamppb.Timestamp)(nil),      // 7: google.protobuf.Timestamp
	(*PaginationRequest)(nil),          // 8: devpod.v1.PaginationRequest
}
var file_devpod_v1_ssh_proto_depIdxs = []int32{
	7, // 0: devpod.v1.SSHPublicKey.creation_time:type_name -> google.protobuf.Timestamp
	7, // 1: devpod.v1.SSHPublicKey.last_used_time:type_name -> google.protobuf.Timestamp
	8, // 2: devpod.v1.ListSSHPublicKeysRequest.pagination:type_name -> devpod.v1.PaginationRequest
	0, // 3: devpod.v1.ListSSHPublicKeysResponse.ssh_keys:type_name -> devpod.v1.SSHPublicKey
	8, // 4: devpod.v1.ListSSHPublicKeysResponse.pagination:type_name -> devpod.v1.PaginationRequest
	0, // 5: devpod.v1.CreateSSHPublicKeyResponse.ssh_key:type_name -> devpod.v1.SSHPublicKey
	1, // 6: devpod.v1.SSHService.ListSSHPublicKeys:input_type -> devpod.v1.ListSSHPublicKeysRequest
	3, // 7: devpod.v1.SSHService.CreateSSHPublicKey:input_type -> devpod.v1.CreateSSHPublicKeyRequest
	5, // 8: devpod.v1.SSHService.DeleteSSHPublicKey:input_type -> devpod.v1.DeleteSSHPublicKeyRequest
	2, // 9: devpod.v1.SSHService.ListSSHPublicKeys:output_type -> devpod.v1.ListSSHPublicKeysResponse
	4, // 10: devpod.v1.SSHService.CreateSSHPublicKey:output_type -> devpod.v1.CreateSSHPublicKeyResponse
	6, // 11: devpod.v1.SSHService.DeleteSSHPublicKey:output_type -> devpod.v1.DeleteSSHPublicKeyResponse
...
func init() { file_devpod_v1_ssh_proto_init() }
func file_devpod_v1_ssh_proto_init() {
	if File_devpod_v1_ssh_proto != nil {
		return
	}
	file_devpod_v1_pagination_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_devpod_v1_ssh_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_ssh_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_ssh_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_ssh_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_ssh_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_ssh_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_ssh_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_devpod_v1_ssh_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_devpod_v1_ssh_proto_goTypes,
		DependencyIndexes: file_devpod_v1_ssh_proto_depIdxs,
		MessageInfos:      file_devpod_v1_ssh_proto_msgTypes,
	}.Build()
	File_devpod_v1_ssh_proto = out.File
	file_devpod_v1_ssh_proto_rawDesc = nil
	file_devpod_v1_ssh_proto_goTypes = nil
	file_devpod_v1_ssh_proto_depIdxs = nil
}
