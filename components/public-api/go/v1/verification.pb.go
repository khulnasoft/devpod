...
func (x *SendPhoneNumberVerificationTokenRequest) Reset() {
	*x = SendPhoneNumberVerificationTokenRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_verification_proto_msgTypes[0]
...
func (*SendPhoneNumberVerificationTokenRequest) Descriptor() ([]byte, []int) {
	return file_devpod_v1_verification_proto_rawDescGZIP(), []int{0}
}
...
func (x *SendPhoneNumberVerificationTokenResponse) Reset() {
	*x = SendPhoneNumberVerificationTokenResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_verification_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SendPhoneNumberVerificationTokenResponse) Descriptor() ([]byte, []int) {
	return file_devpod_v1_verification_proto_rawDescGZIP(), []int{1}
}
...
func (x *VerifyPhoneNumberVerificationTokenRequest) Reset() {
	*x = VerifyPhoneNumberVerificationTokenRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_verification_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VerifyPhoneNumberVerificationTokenRequest) Descriptor() ([]byte, []int) {
	return file_devpod_v1_verification_proto_rawDescGZIP(), []int{2}
}
...
func (x *VerifyPhoneNumberVerificationTokenResponse) Reset() {
	*x = VerifyPhoneNumberVerificationTokenResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_verification_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VerifyPhoneNumberVerificationTokenResponse) Descriptor() ([]byte, []int) {
	return file_devpod_v1_verification_proto_rawDescGZIP(), []int{3}
}
...
var File_devpod_v1_verification_proto protoreflect.FileDescriptor

var file_devpod_v1_verification_proto_rawDesc = []byte{
...
var (
	file_devpod_v1_verification_proto_rawDescOnce sync.Once
	file_devpod_v1_verification_proto_rawDescData = file_devpod_v1_verification_proto_rawDesc
)

func file_devpod_v1_verification_proto_rawDescGZIP() []byte {
	file_devpod_v1_verification_proto_rawDescOnce.Do(func() {
		file_devpod_v1_verification_proto_rawDescData = protoimpl.X.CompressGZIP(file_devpod_v1_verification_proto_rawDescData)
	})
	return file_devpod_v1_verification_proto_rawDescData
}

var file_devpod_v1_verification_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_devpod_v1_verification_proto_goTypes = []interface{}{
	(*SendPhoneNumberVerificationTokenRequest)(nil),    // 0: devpod.v1.SendPhoneNumberVerificationTokenRequest
	(*SendPhoneNumberVerificationTokenResponse)(nil),   // 1: devpod.v1.SendPhoneNumberVerificationTokenResponse
	(*VerifyPhoneNumberVerificationTokenRequest)(nil),  // 2: devpod.v1.VerifyPhoneNumberVerificationTokenRequest
	(*VerifyPhoneNumberVerificationTokenResponse)(nil), // 3: devpod.v1.VerifyPhoneNumberVerificationTokenResponse
}
var file_devpod_v1_verification_proto_depIdxs = []int32{
	0, // 0: devpod.v1.VerificationService.SendPhoneNumberVerificationToken:input_type -> devpod.v1.SendPhoneNumberVerificationTokenRequest
	2, // 1: devpod.v1.VerificationService.VerifyPhoneNumberVerificationToken:input_type -> devpod.v1.VerifyPhoneNumberVerificationTokenRequest
	1, // 2: devpod.v1.VerificationService.SendPhoneNumberVerificationToken:output_type -> devpod.v1.SendPhoneNumberVerificationTokenResponse
	3, // 3: devpod.v1.VerificationService.VerifyPhoneNumberVerificationToken:output_type -> devpod.v1.VerifyPhoneNumberVerificationTokenResponse
...
func init() { file_devpod_v1_verification_proto_init() }
func file_devpod_v1_verification_proto_init() {
	if File_devpod_v1_verification_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_devpod_v1_verification_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_verification_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_verification_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_verification_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_devpod_v1_verification_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_devpod_v1_verification_proto_goTypes,
		DependencyIndexes: file_devpod_v1_verification_proto_depIdxs,
		MessageInfos:      file_devpod_v1_verification_proto_msgTypes,
	}.Build()
	File_devpod_v1_verification_proto = out.File
	file_devpod_v1_verification_proto_rawDesc = nil
	file_devpod_v1_verification_proto_goTypes = nil
	file_devpod_v1_verification_proto_depIdxs = nil
}
