...
func (x *EditorReference) Reset() {
	*x = EditorReference{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_editor_proto_msgTypes[0]
...
func (*EditorReference) Descriptor() ([]byte, []int) {
	return file_devpod_v1_editor_proto_rawDescGZIP(), []int{0}
}
...
var File_devpod_v1_editor_proto protoreflect.FileDescriptor

var file_devpod_v1_editor_proto_rawDesc = []byte{
...
var (
	file_devpod_v1_editor_proto_rawDescOnce sync.Once
	file_devpod_v1_editor_proto_rawDescData = file_devpod_v1_editor_proto_rawDesc
)

func file_devpod_v1_editor_proto_rawDescGZIP() []byte {
	file_devpod_v1_editor_proto_rawDescOnce.Do(func() {
		file_devpod_v1_editor_proto_rawDescData = protoimpl.X.CompressGZIP(file_devpod_v1_editor_proto_rawDescData)
	})
	return file_devpod_v1_editor_proto_rawDescData
}

var file_devpod_v1_editor_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_devpod_v1_editor_proto_goTypes = []interface{}{
	(*EditorReference)(nil), // 0: devpod.v1.EditorReference
}
var file_devpod_v1_editor_proto_depIdxs = []int32{
...
func init() { file_devpod_v1_editor_proto_init() }
func file_devpod_v1_editor_proto_init() {
	if File_devpod_v1_editor_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_devpod_v1_editor_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_devpod_v1_editor_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_devpod_v1_editor_proto_goTypes,
		DependencyIndexes: file_devpod_v1_editor_proto_depIdxs,
		MessageInfos:      file_devpod_v1_editor_proto_msgTypes,
	}.Build()
	File_devpod_v1_editor_proto = out.File
	file_devpod_v1_editor_proto_rawDesc = nil
	file_devpod_v1_editor_proto_goTypes = nil
	file_devpod_v1_editor_proto_depIdxs = nil
}
