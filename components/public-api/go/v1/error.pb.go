...
func (x *PermissionDeniedDetails) Reset() {
	*x = PermissionDeniedDetails{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_error_proto_msgTypes[0]
...
func (*PermissionDeniedDetails) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{0}
}
...
func (x *UserBlockedError) Reset() {
	*x = UserBlockedError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_error_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserBlockedError) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{1}
}
...
func (x *NeedsVerificationError) Reset() {
	*x = NeedsVerificationError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_error_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NeedsVerificationError) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{2}
}
...
func (x *FailedPreconditionDetails) Reset() {
	*x = FailedPreconditionDetails{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_error_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FailedPreconditionDetails) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{3}
}
...
type FailedPreconditionDetails_InvalidGitpodYml struct {
	InvalidGitpodYml *InvalidGitpodYMLError `protobuf:"bytes,4,opt,name=invalid_devpod_yml,json=invalidGitpodYml,proto3,oneof"`
}
...
func (x *PaymentSpendingLimitReachedError) Reset() {
	*x = PaymentSpendingLimitReachedError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_error_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PaymentSpendingLimitReachedError) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{4}
}
...
func (x *InvalidCostCenterError) Reset() {
	*x = InvalidCostCenterError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_error_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InvalidCostCenterError) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{5}
}
...
func (x *TooManyRunningWorkspacesError) Reset() {
	*x = TooManyRunningWorkspacesError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_error_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TooManyRunningWorkspacesError) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{6}
}
...
func (x *InvalidGitpodYMLError) Reset() {
	*x = InvalidGitpodYMLError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_error_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InvalidGitpodYMLError) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{7}
}
...
func (x *RepositoryNotFoundError) Reset() {
	*x = RepositoryNotFoundError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_error_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RepositoryNotFoundError) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{8}
}
...
func (x *RepositoryUnauthorizedError) Reset() {
	*x = RepositoryUnauthorizedError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_error_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RepositoryUnauthorizedError) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{9}
}
...
func (x *ImageBuildLogsNotYetAvailableError) Reset() {
	*x = ImageBuildLogsNotYetAvailableError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_error_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ImageBuildLogsNotYetAvailableError) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{10}
}
...
func (x *CellDisabledError) Reset() {
	*x = CellDisabledError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_v1_error_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CellDisabledError) Descriptor() ([]byte, []int) {
	return file_devpod_v1_error_proto_rawDescGZIP(), []int{11}
}

var File_devpod_v1_error_proto protoreflect.FileDescriptor

var file_devpod_v1_error_proto_rawDesc = []byte{
...
var (
	file_devpod_v1_error_proto_rawDescOnce sync.Once
	file_devpod_v1_error_proto_rawDescData = file_devpod_v1_error_proto_rawDesc
)

func file_devpod_v1_error_proto_rawDescGZIP() []byte {
	file_devpod_v1_error_proto_rawDescOnce.Do(func() {
		file_devpod_v1_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_devpod_v1_error_proto_rawDescData)
	})
	return file_devpod_v1_error_proto_rawDescData
}

var file_devpod_v1_error_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_devpod_v1_error_proto_goTypes = []interface{}{
	(*PermissionDeniedDetails)(nil),            // 0: devpod.v1.PermissionDeniedDetails
	(*UserBlockedError)(nil),                   // 1: devpod.v1.UserBlockedError
	(*NeedsVerificationError)(nil),             // 2: devpod.v1.NeedsVerificationError
	(*FailedPreconditionDetails)(nil),          // 3: devpod.v1.FailedPreconditionDetails
	(*PaymentSpendingLimitReachedError)(nil),   // 4: devpod.v1.PaymentSpendingLimitReachedError
	(*InvalidCostCenterError)(nil),             // 5: devpod.v1.InvalidCostCenterError
	(*TooManyRunningWorkspacesError)(nil),      // 6: devpod.v1.TooManyRunningWorkspacesError
	(*InvalidGitpodYMLError)(nil),              // 7: devpod.v1.InvalidGitpodYMLError
	(*RepositoryNotFoundError)(nil),            // 8: devpod.v1.RepositoryNotFoundError
	(*RepositoryUnauthorizedError)(nil),        // 9: devpod.v1.RepositoryUnauthorizedError
	(*ImageBuildLogsNotYetAvailableError)(nil), // 10: devpod.v1.ImageBuildLogsNotYetAvailableError
	(*CellDisabledError)(nil),                  // 11: devpod.v1.CellDisabledError
}
var file_devpod_v1_error_proto_depIdxs = []int32{
	1,  // 0: devpod.v1.PermissionDeniedDetails.user_blocked:type_name -> devpod.v1.UserBlockedError
	2,  // 1: devpod.v1.PermissionDeniedDetails.needs_verification:type_name -> devpod.v1.NeedsVerificationError
	4,  // 2: devpod.v1.FailedPreconditionDetails.payment_spending_limit_reached:type_name -> devpod.v1.PaymentSpendingLimitReachedError
	5,  // 3: devpod.v1.FailedPreconditionDetails.invalid_cost_center:type_name -> devpod.v1.InvalidCostCenterError
	6,  // 4: devpod.v1.FailedPreconditionDetails.too_many_running_workspaces:type_name -> devpod.v1.TooManyRunningWorkspacesError
	7,  // 5: devpod.v1.FailedPreconditionDetails.invalid_devpod_yml:type_name -> devpod.v1.InvalidGitpodYMLError
	8,  // 6: devpod.v1.FailedPreconditionDetails.repository_not_found:type_name -> devpod.v1.RepositoryNotFoundError
	9,  // 7: devpod.v1.FailedPreconditionDetails.repository_unauthorized:type_name -> devpod.v1.RepositoryUnauthorizedError
	10, // 8: devpod.v1.FailedPreconditionDetails.image_build_logs_not_yet_available:type_name -> devpod.v1.ImageBuildLogsNotYetAvailableError
	11, // 9: devpod.v1.FailedPreconditionDetails.cell_is_disabled:type_name -> devpod.v1.CellDisabledError
...
func init() { file_devpod_v1_error_proto_init() }
func file_devpod_v1_error_proto_init() {
	if File_devpod_v1_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_devpod_v1_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_error_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_error_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_error_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_error_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_error_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_error_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_error_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_error_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_error_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_error_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_v1_error_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
	...
	file_devpod_v1_error_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*PermissionDeniedDetails_UserBlocked)(nil),
		(*PermissionDeniedDetails_NeedsVerification)(nil),
	}
	file_devpod_v1_error_proto_msgTypes[3].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_devpod_v1_error_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_devpod_v1_error_proto_goTypes,
		DependencyIndexes: file_devpod_v1_error_proto_depIdxs,
		MessageInfos:      file_devpod_v1_error_proto_msgTypes,
	}.Build()
	File_devpod_v1_error_proto = out.File
	file_devpod_v1_error_proto_rawDesc = nil
	file_devpod_v1_error_proto_goTypes = nil
	file_devpod_v1_error_proto_depIdxs = nil
}
