...
func (x *SendHeartbeatRequest) Reset() {
	*x = SendHeartbeatRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_ide_client_proto_msgTypes[0]
...
func (*SendHeartbeatRequest) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_ide_client_proto_rawDescGZIP(), []int{0}
}
...
func (x *SendHeartbeatResponse) Reset() {
	*x = SendHeartbeatResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_ide_client_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SendHeartbeatResponse) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_ide_client_proto_rawDescGZIP(), []int{1}
}
...
func (x *SendDidCloseRequest) Reset() {
	*x = SendDidCloseRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_ide_client_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SendDidCloseRequest) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_ide_client_proto_rawDescGZIP(), []int{2}
}
...
func (x *SendDidCloseResponse) Reset() {
	*x = SendDidCloseResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_ide_client_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SendDidCloseResponse) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_ide_client_proto_rawDescGZIP(), []int{3}
}
...
func (x *UpdateGitStatusRequest) Reset() {
	*x = UpdateGitStatusRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_ide_client_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateGitStatusRequest) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_ide_client_proto_rawDescGZIP(), []int{4}
}
...
func (x *UpdateGitStatusResponse) Reset() {
	*x = UpdateGitStatusResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_ide_client_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UpdateGitStatusResponse) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_ide_client_proto_rawDescGZIP(), []int{5}
}

var File_devpod_experimental_v1_ide_client_proto protoreflect.FileDescriptor

var file_devpod_experimental_v1_ide_client_proto_rawDesc = []byte{
...
var (
	file_devpod_experimental_v1_ide_client_proto_rawDescOnce sync.Once
	file_devpod_experimental_v1_ide_client_proto_rawDescData = file_devpod_experimental_v1_ide_client_proto_rawDesc
)

func file_devpod_experimental_v1_ide_client_proto_rawDescGZIP() []byte {
	file_devpod_experimental_v1_ide_client_proto_rawDescOnce.Do(func() {
		file_devpod_experimental_v1_ide_client_proto_rawDescData = protoimpl.X.CompressGZIP(file_devpod_experimental_v1_ide_client_proto_rawDescData)
	})
	return file_devpod_experimental_v1_ide_client_proto_rawDescData
}

var file_devpod_experimental_v1_ide_client_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_devpod_experimental_v1_ide_client_proto_goTypes = []interface{}{
	(*SendHeartbeatRequest)(nil),    // 0: devpod.experimental.v1.SendHeartbeatRequest
	(*SendHeartbeatResponse)(nil),   // 1: devpod.experimental.v1.SendHeartbeatResponse
	(*SendDidCloseRequest)(nil),     // 2: devpod.experimental.v1.SendDidCloseRequest
	(*SendDidCloseResponse)(nil),    // 3: devpod.experimental.v1.SendDidCloseResponse
	(*UpdateGitStatusRequest)(nil),  // 4: devpod.experimental.v1.UpdateGitStatusRequest
	(*UpdateGitStatusResponse)(nil), // 5: devpod.experimental.v1.UpdateGitStatusResponse
	(*GitStatus)(nil),               // 6: devpod.experimental.v1.GitStatus
}
var file_devpod_experimental_v1_ide_client_proto_depIdxs = []int32{
	6, // 0: devpod.experimental.v1.UpdateGitStatusRequest.status:type_name -> devpod.experimental.v1.GitStatus
	0, // 1: devpod.experimental.v1.IDEClientService.SendHeartbeat:input_type -> devpod.experimental.v1.SendHeartbeatRequest
	2, // 2: devpod.experimental.v1.IDEClientService.SendDidClose:input_type -> devpod.experimental.v1.SendDidCloseRequest
	4, // 3: devpod.experimental.v1.IDEClientService.UpdateGitStatus:input_type -> devpod.experimental.v1.UpdateGitStatusRequest
	1, // 4: devpod.experimental.v1.IDEClientService.SendHeartbeat:output_type -> devpod.experimental.v1.SendHeartbeatResponse
	3, // 5: devpod.experimental.v1.IDEClientService.SendDidClose:output_type -> devpod.experimental.v1.SendDidCloseResponse
	5, // 6: devpod.experimental.v1.IDEClientService.UpdateGitStatus:output_type -> devpod.experimental.v1.UpdateGitStatusResponse
...
func init() { file_devpod_experimental_v1_ide_client_proto_init() }
func file_devpod_experimental_v1_ide_client_proto_init() {
	if File_devpod_experimental_v1_ide_client_proto != nil {
		return
	}
	file_devpod_experimental_v1_workspaces_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_devpod_experimental_v1_ide_client_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_experimental_v1_ide_client_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_experimental_v1_ide_client_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_experimental_v1_ide_client_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_experimental_v1_ide_client_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_experimental_v1_ide_client_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_devpod_experimental_v1_ide_client_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_devpod_experimental_v1_ide_client_proto_goTypes,
		DependencyIndexes: file_devpod_experimental_v1_ide_client_proto_depIdxs,
		MessageInfos:      file_devpod_experimental_v1_ide_client_proto_msgTypes,
	}.Build()
	File_devpod_experimental_v1_ide_client_proto = out.File
	file_devpod_experimental_v1_ide_client_proto_rawDesc = nil
	file_devpod_experimental_v1_ide_client_proto_goTypes = nil
	file_devpod_experimental_v1_ide_client_proto_depIdxs = nil
}
