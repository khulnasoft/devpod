...
const (
	...
	ProjectsServiceName = "devpod.experimental.v1.ProjectsService"
)

// ProjectsServiceClient is a client for the devpod.experimental.v1.ProjectsService service.
...
// NewProjectsServiceClient constructs a client for the devpod.experimental.v1.ProjectsService
...
// CreateProject calls devpod.experimental.v1.ProjectsService.CreateProject.
...
// GetProject calls devpod.experimental.v1.ProjectsService.GetProject.
...
// ListProjects calls devpod.experimental.v1.ProjectsService.ListProjects.
...
// DeleteProject calls devpod.experimental.v1.ProjectsService.DeleteProject.
...
// ProjectsServiceHandler is an implementation of the devpod.experimental.v1.ProjectsService
// service.
...
func NewProjectsServiceHandler(svc ProjectsServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.experimental.v1.ProjectsService/CreateProject", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.ProjectsService/CreateProject",
		svc.CreateProject,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.ProjectsService/GetProject", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.ProjectsService/GetProject",
		svc.GetProject,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.ProjectsService/ListProjects", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.ProjectsService/ListProjects",
		svc.ListProjects,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.ProjectsService/DeleteProject", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.ProjectsService/DeleteProject",
		svc.DeleteProject,
		opts...,
	))
	return "/devpod.experimental.v1.ProjectsService/", mux
}
...
func (UnimplementedProjectsServiceHandler) CreateProject(context.Context, *connect_go.Request[v1.CreateProjectRequest]) (*connect_go.Response[v1.CreateProjectResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.ProjectsService.CreateProject is not implemented"))
}
...
func (UnimplementedProjectsServiceHandler) GetProject(context.Context, *connect_go.Request[v1.GetProjectRequest]) (*connect_go.Response[v1.GetProjectResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.ProjectsService.GetProject is not implemented"))
}
...
func (UnimplementedProjectsServiceHandler) ListProjects(context.Context, *connect_go.Request[v1.ListProjectsRequest]) (*connect_go.Response[v1.ListProjectsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.ProjectsService.ListProjects is not implemented"))
}
...
func (UnimplementedProjectsServiceHandler) DeleteProject(context.Context, *connect_go.Request[v1.DeleteProjectRequest]) (*connect_go.Response[v1.DeleteProjectResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.ProjectsService.DeleteProject is not implemented"))
}
