...
const (
	...
	SCMServiceName = "devpod.experimental.v1.SCMService"
)

// SCMServiceClient is a client for the devpod.experimental.v1.SCMService service.
...
// NewSCMServiceClient constructs a client for the devpod.experimental.v1.SCMService service. By
...
func NewSCMServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) SCMServiceClient {
	...
	return &sCMServiceClient{
		getSuggestedRepoURLs: connect_go.NewClient[v1.GetSuggestedRepoURLsRequest, v1.GetSuggestedRepoURLsResponse](
			httpClient,
			baseURL+"/devpod.experimental.v1.SCMService/GetSuggestedRepoURLs",
			opts...,
		),
	}
}
...
// GetSuggestedRepoURLs calls devpod.experimental.v1.SCMService.GetSuggestedRepoURLs.
...
// SCMServiceHandler is an implementation of the devpod.experimental.v1.SCMService service.
...
func NewSCMServiceHandler(svc SCMServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.experimental.v1.SCMService/GetSuggestedRepoURLs", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.SCMService/GetSuggestedRepoURLs",
		svc.GetSuggestedRepoURLs,
		opts...,
	))
	return "/devpod.experimental.v1.SCMService/", mux
}
...
func (UnimplementedSCMServiceHandler) GetSuggestedRepoURLs(context.Context, *connect_go.Request[v1.GetSuggestedRepoURLsRequest]) (*connect_go.Response[v1.GetSuggestedRepoURLsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.SCMService.GetSuggestedRepoURLs is not implemented"))
}
