...
const (
	...
	EditorServiceName = "devpod.experimental.v1.EditorService"
)

// EditorServiceClient is a client for the devpod.experimental.v1.EditorService service.
...
// NewEditorServiceClient constructs a client for the devpod.experimental.v1.EditorService service.
...
func NewEditorServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) EditorServiceClient {
	...
	return &editorServiceClient{
		listEditorOptions: connect_go.NewClient[v1.ListEditorOptionsRequest, v1.ListEditorOptionsResponse](
			httpClient,
			baseURL+"/devpod.experimental.v1.EditorService/ListEditorOptions",
			opts...,
		),
	}
}
...
// ListEditorOptions calls devpod.experimental.v1.EditorService.ListEditorOptions.
...
// EditorServiceHandler is an implementation of the devpod.experimental.v1.EditorService service.
...
func NewEditorServiceHandler(svc EditorServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.experimental.v1.EditorService/ListEditorOptions", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.EditorService/ListEditorOptions",
		svc.ListEditorOptions,
		opts...,
	))
	return "/devpod.experimental.v1.EditorService/", mux
}
...
func (UnimplementedEditorServiceHandler) ListEditorOptions(context.Context, *connect_go.Request[v1.ListEditorOptionsRequest]) (*connect_go.Response[v1.ListEditorOptionsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.EditorService.ListEditorOptions is not implemented"))
}
