...
const (
	...
	IDEClientServiceName = "devpod.experimental.v1.IDEClientService"
)

// IDEClientServiceClient is a client for the devpod.experimental.v1.IDEClientService service.
...
// NewIDEClientServiceClient constructs a client for the devpod.experimental.v1.IDEClientService
...
func NewIDEClientServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) IDEClientServiceClient {
	...
	return &iDEClientServiceClient{
		sendHeartbeat: connect_go.NewClient[v1.SendHeartbeatRequest, v1.SendHeartbeatResponse](
			httpClient,
			baseURL+"/devpod.experimental.v1.IDEClientService/SendHeartbeat",
			opts...,
		),
		sendDidClose: connect_go.NewClient[v1.SendDidCloseRequest, v1.SendDidCloseResponse](
			httpClient,
			baseURL+"/devpod.experimental.v1.IDEClientService/SendDidClose",
			opts...,
		),
		updateGitStatus: connect_go.NewClient[v1.UpdateGitStatusRequest, v1.UpdateGitStatusResponse](
			httpClient,
			baseURL+"/devpod.experimental.v1.IDEClientService/UpdateGitStatus",
			opts...,
		),
	}
}
...
// SendHeartbeat calls devpod.experimental.v1.IDEClientService.SendHeartbeat.
...
// SendDidClose calls devpod.experimental.v1.IDEClientService.SendDidClose.
...
// UpdateGitStatus calls devpod.experimental.v1.IDEClientService.UpdateGitStatus.
...
// IDEClientServiceHandler is an implementation of the devpod.experimental.v1.IDEClientService
// service.
...
func NewIDEClientServiceHandler(svc IDEClientServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.experimental.v1.IDEClientService/SendHeartbeat", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.IDEClientService/SendHeartbeat",
		svc.SendHeartbeat,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.IDEClientService/SendDidClose", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.IDEClientService/SendDidClose",
		svc.SendDidClose,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.IDEClientService/UpdateGitStatus", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.IDEClientService/UpdateGitStatus",
		svc.UpdateGitStatus,
		opts...,
	))
	return "/devpod.experimental.v1.IDEClientService/", mux
}
...
func (UnimplementedIDEClientServiceHandler) SendHeartbeat(context.Context, *connect_go.Request[v1.SendHeartbeatRequest]) (*connect_go.Response[v1.SendHeartbeatResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.IDEClientService.SendHeartbeat is not implemented"))
}
...
func (UnimplementedIDEClientServiceHandler) SendDidClose(context.Context, *connect_go.Request[v1.SendDidCloseRequest]) (*connect_go.Response[v1.SendDidCloseResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.IDEClientService.SendDidClose is not implemented"))
}
...
func (UnimplementedIDEClientServiceHandler) UpdateGitStatus(context.Context, *connect_go.Request[v1.UpdateGitStatusRequest]) (*connect_go.Response[v1.UpdateGitStatusResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.IDEClientService.UpdateGitStatus is not implemented"))
}
