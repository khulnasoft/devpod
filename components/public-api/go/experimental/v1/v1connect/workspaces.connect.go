...
const (
	...
	WorkspacesServiceName = "devpod.experimental.v1.WorkspacesService"
)

// WorkspacesServiceClient is a client for the devpod.experimental.v1.WorkspacesService service.
...
// NewWorkspacesServiceClient constructs a client for the devpod.experimental.v1.WorkspacesService
...
// ListWorkspaces calls devpod.experimental.v1.WorkspacesService.ListWorkspaces.
...
// GetWorkspace calls devpod.experimental.v1.WorkspacesService.GetWorkspace.
...
// StreamWorkspaceStatus calls devpod.experimental.v1.WorkspacesService.StreamWorkspaceStatus.
...
// GetOwnerToken calls devpod.experimental.v1.WorkspacesService.GetOwnerToken.
...
// CreateAndStartWorkspace calls devpod.experimental.v1.WorkspacesService.CreateAndStartWorkspace.
...
// StartWorkspace calls devpod.experimental.v1.WorkspacesService.StartWorkspace.
...
// StopWorkspace calls devpod.experimental.v1.WorkspacesService.StopWorkspace.
...
// DeleteWorkspace calls devpod.experimental.v1.WorkspacesService.DeleteWorkspace.
...
// UpdatePort calls devpod.experimental.v1.WorkspacesService.UpdatePort.
...
// ListWorkspaceClasses calls devpod.experimental.v1.WorkspacesService.ListWorkspaceClasses.
...
// GetDefaultWorkspaceImage calls devpod.experimental.v1.WorkspacesService.GetDefaultWorkspaceImage.
...
// WorkspacesServiceHandler is an implementation of the devpod.experimental.v1.WorkspacesService
// service.
...
func NewWorkspacesServiceHandler(svc WorkspacesServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.experimental.v1.WorkspacesService/ListWorkspaces", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.WorkspacesService/ListWorkspaces",
		svc.ListWorkspaces,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.WorkspacesService/GetWorkspace", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.WorkspacesService/GetWorkspace",
		svc.GetWorkspace,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.WorkspacesService/StreamWorkspaceStatus", connect_go.NewServerStreamHandler(
		"/devpod.experimental.v1.WorkspacesService/StreamWorkspaceStatus",
		svc.StreamWorkspaceStatus,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.WorkspacesService/GetOwnerToken", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.WorkspacesService/GetOwnerToken",
		svc.GetOwnerToken,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.WorkspacesService/CreateAndStartWorkspace", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.WorkspacesService/CreateAndStartWorkspace",
		svc.CreateAndStartWorkspace,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.WorkspacesService/StartWorkspace", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.WorkspacesService/StartWorkspace",
		svc.StartWorkspace,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.WorkspacesService/StopWorkspace", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.WorkspacesService/StopWorkspace",
		svc.StopWorkspace,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.WorkspacesService/DeleteWorkspace", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.WorkspacesService/DeleteWorkspace",
		svc.DeleteWorkspace,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.WorkspacesService/UpdatePort", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.WorkspacesService/UpdatePort",
		svc.UpdatePort,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.WorkspacesService/ListWorkspaceClasses", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.WorkspacesService/ListWorkspaceClasses",
		svc.ListWorkspaceClasses,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.WorkspacesService/GetDefaultWorkspaceImage", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.WorkspacesService/GetDefaultWorkspaceImage",
		svc.GetDefaultWorkspaceImage,
		opts...,
	))
	return "/devpod.experimental.v1.WorkspacesService/", mux
}
...
func (UnimplementedWorkspacesServiceHandler) ListWorkspaces(context.Context, *connect_go.Request[v1.ListWorkspacesRequest]) (*connect_go.Response[v1.ListWorkspacesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.WorkspacesService.ListWorkspaces is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) GetWorkspace(context.Context, *connect_go.Request[v1.GetWorkspaceRequest]) (*connect_go.Response[v1.GetWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.WorkspacesService.GetWorkspace is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) StreamWorkspaceStatus(context.Context, *connect_go.Request[v1.StreamWorkspaceStatusRequest], *connect_go.ServerStream[v1.StreamWorkspaceStatusResponse]) error {
	return connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.WorkspacesService.StreamWorkspaceStatus is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) GetOwnerToken(context.Context, *connect_go.Request[v1.GetOwnerTokenRequest]) (*connect_go.Response[v1.GetOwnerTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.WorkspacesService.GetOwnerToken is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) CreateAndStartWorkspace(context.Context, *connect_go.Request[v1.CreateAndStartWorkspaceRequest]) (*connect_go.Response[v1.CreateAndStartWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.WorkspacesService.CreateAndStartWorkspace is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) StartWorkspace(context.Context, *connect_go.Request[v1.StartWorkspaceRequest]) (*connect_go.Response[v1.StartWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.WorkspacesService.StartWorkspace is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) StopWorkspace(context.Context, *connect_go.Request[v1.StopWorkspaceRequest]) (*connect_go.Response[v1.StopWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.WorkspacesService.StopWorkspace is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) DeleteWorkspace(context.Context, *connect_go.Request[v1.DeleteWorkspaceRequest]) (*connect_go.Response[v1.DeleteWorkspaceResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.WorkspacesService.DeleteWorkspace is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) UpdatePort(context.Context, *connect_go.Request[v1.UpdatePortRequest]) (*connect_go.Response[v1.UpdatePortResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.WorkspacesService.UpdatePort is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) ListWorkspaceClasses(context.Context, *connect_go.Request[v1.ListWorkspaceClassesRequest]) (*connect_go.Response[v1.ListWorkspaceClassesResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.WorkspacesService.ListWorkspaceClasses is not implemented"))
}
...
func (UnimplementedWorkspacesServiceHandler) GetDefaultWorkspaceImage(context.Context, *connect_go.Request[v1.GetDefaultWorkspaceImageRequest]) (*connect_go.Response[v1.GetDefaultWorkspaceImageResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.WorkspacesService.GetDefaultWorkspaceImage is not implemented"))
}
