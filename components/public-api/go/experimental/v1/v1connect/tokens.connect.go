...
const (
	...
	TokensServiceName = "devpod.experimental.v1.TokensService"
)

// TokensServiceClient is a client for the devpod.experimental.v1.TokensService service.
...
// NewTokensServiceClient constructs a client for the devpod.experimental.v1.TokensService service.
...
// CreatePersonalAccessToken calls devpod.experimental.v1.TokensService.CreatePersonalAccessToken.
...
// GetPersonalAccessToken calls devpod.experimental.v1.TokensService.GetPersonalAccessToken.
...
// ListPersonalAccessTokens calls devpod.experimental.v1.TokensService.ListPersonalAccessTokens.
...
// UpdatePersonalAccessToken calls devpod.experimental.v1.TokensService.UpdatePersonalAccessToken.
...
// DeletePersonalAccessToken calls devpod.experimental.v1.TokensService.DeletePersonalAccessToken.
...
// TokensServiceHandler is an implementation of the devpod.experimental.v1.TokensService service.
...
func NewTokensServiceHandler(svc TokensServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.experimental.v1.TokensService/CreatePersonalAccessToken", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.TokensService/CreatePersonalAccessToken",
		svc.CreatePersonalAccessToken,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.TokensService/GetPersonalAccessToken", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.TokensService/GetPersonalAccessToken",
		svc.GetPersonalAccessToken,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.TokensService/ListPersonalAccessTokens", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.TokensService/ListPersonalAccessTokens",
		svc.ListPersonalAccessTokens,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.TokensService/RegeneratePersonalAccessToken", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.TokensService/RegeneratePersonalAccessToken",
		svc.RegeneratePersonalAccessToken,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.TokensService/UpdatePersonalAccessToken", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.TokensService/UpdatePersonalAccessToken",
		svc.UpdatePersonalAccessToken,
		opts...,
	))
	mux.Handle("/devpod.experimental.v1.TokensService/DeletePersonalAccessToken", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.TokensService/DeletePersonalAccessToken",
		svc.DeletePersonalAccessToken,
		opts...,
	))
	return "/devpod.experimental.v1.TokensService/", mux
}
...
func (UnimplementedTokensServiceHandler) CreatePersonalAccessToken(context.Context, *connect_go.Request[v1.CreatePersonalAccessTokenRequest]) (*connect_go.Response[v1.CreatePersonalAccessTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.TokensService.CreatePersonalAccessToken is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) GetPersonalAccessToken(context.Context, *connect_go.Request[v1.GetPersonalAccessTokenRequest]) (*connect_go.Response[v1.GetPersonalAccessTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.TokensService.GetPersonalAccessToken is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) ListPersonalAccessTokens(context.Context, *connect_go.Request[v1.ListPersonalAccessTokensRequest]) (*connect_go.Response[v1.ListPersonalAccessTokensResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.TokensService.ListPersonalAccessTokens is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) RegeneratePersonalAccessToken(context.Context, *connect_go.Request[v1.RegeneratePersonalAccessTokenRequest]) (*connect_go.Response[v1.RegeneratePersonalAccessTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.TokensService.RegeneratePersonalAccessToken is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) UpdatePersonalAccessToken(context.Context, *connect_go.Request[v1.UpdatePersonalAccessTokenRequest]) (*connect_go.Response[v1.UpdatePersonalAccessTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.TokensService.UpdatePersonalAccessToken is not implemented"))
}
...
func (UnimplementedTokensServiceHandler) DeletePersonalAccessToken(context.Context, *connect_go.Request[v1.DeletePersonalAccessTokenRequest]) (*connect_go.Response[v1.DeletePersonalAccessTokenResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.TokensService.DeletePersonalAccessToken is not implemented"))
}
