...
const (
	...
	StatsServiceName = "devpod.experimental.v1.StatsService"
)

// StatsServiceClient is a client for the devpod.experimental.v1.StatsService service.
...
// NewStatsServiceClient constructs a client for the devpod.experimental.v1.StatsService service. By
...
func NewStatsServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) StatsServiceClient {
	...
	return &statsServiceClient{
		getUserStats: connect_go.NewClient[v1.GetUserStatsRequest, v1.GetUserStatsResponse](
			httpClient,
			baseURL+"/devpod.experimental.v1.StatsService/GetUserStats",
			opts...,
		),
	}
}
...
// GetUserStats calls devpod.experimental.v1.StatsService.GetUserStats.
...
// StatsServiceHandler is an implementation of the devpod.experimental.v1.StatsService service.
...
func NewStatsServiceHandler(svc StatsServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/devpod.experimental.v1.StatsService/GetUserStats", connect_go.NewUnaryHandler(
		"/devpod.experimental.v1.StatsService/GetUserStats",
		svc.GetUserStats,
		opts...,
	))
	return "/devpod.experimental.v1.StatsService/", mux
}
...
func (UnimplementedStatsServiceHandler) GetUserStats(context.Context, *connect_go.Request[v1.GetUserStatsRequest]) (*connect_go.Response[v1.GetUserStatsResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("devpod.experimental.v1.StatsService.GetUserStats is not implemented"))
}
