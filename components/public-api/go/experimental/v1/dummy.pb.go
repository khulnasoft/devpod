...
func (x *SayHelloRequest) Reset() {
	*x = SayHelloRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_dummy_proto_msgTypes[0]
...
func (*SayHelloRequest) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_dummy_proto_rawDescGZIP(), []int{0}
}
...
func (x *SayHelloResponse) Reset() {
	*x = SayHelloResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_dummy_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SayHelloResponse) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_dummy_proto_rawDescGZIP(), []int{1}
}
...
func (x *LotsOfRepliesRequest) Reset() {
	*x = LotsOfRepliesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_dummy_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LotsOfRepliesRequest) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_dummy_proto_rawDescGZIP(), []int{2}
}
...
func (x *LotsOfRepliesResponse) Reset() {
	*x = LotsOfRepliesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_dummy_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LotsOfRepliesResponse) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_dummy_proto_rawDescGZIP(), []int{3}
}
...
var File_devpod_experimental_v1_dummy_proto protoreflect.FileDescriptor

var file_devpod_experimental_v1_dummy_proto_rawDesc = []byte{
...
var (
	file_devpod_experimental_v1_dummy_proto_rawDescOnce sync.Once
	file_devpod_experimental_v1_dummy_proto_rawDescData = file_devpod_experimental_v1_dummy_proto_rawDesc
)

func file_devpod_experimental_v1_dummy_proto_rawDescGZIP() []byte {
	file_devpod_experimental_v1_dummy_proto_rawDescOnce.Do(func() {
		file_devpod_experimental_v1_dummy_proto_rawDescData = protoimpl.X.CompressGZIP(file_devpod_experimental_v1_dummy_proto_rawDescData)
	})
	return file_devpod_experimental_v1_dummy_proto_rawDescData
}

var file_devpod_experimental_v1_dummy_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_devpod_experimental_v1_dummy_proto_goTypes = []interface{}{
	(*SayHelloRequest)(nil),       // 0: devpod.experimental.v1.SayHelloRequest
	(*SayHelloResponse)(nil),      // 1: devpod.experimental.v1.SayHelloResponse
	(*LotsOfRepliesRequest)(nil),  // 2: devpod.experimental.v1.LotsOfRepliesRequest
	(*LotsOfRepliesResponse)(nil), // 3: devpod.experimental.v1.LotsOfRepliesResponse
}
var file_devpod_experimental_v1_dummy_proto_depIdxs = []int32{
	0, // 0: devpod.experimental.v1.HelloService.SayHello:input_type -> devpod.experimental.v1.SayHelloRequest
	2, // 1: devpod.experimental.v1.HelloService.LotsOfReplies:input_type -> devpod.experimental.v1.LotsOfRepliesRequest
	1, // 2: devpod.experimental.v1.HelloService.SayHello:output_type -> devpod.experimental.v1.SayHelloResponse
	3, // 3: devpod.experimental.v1.HelloService.LotsOfReplies:output_type -> devpod.experimental.v1.LotsOfRepliesResponse
...
func init() { file_devpod_experimental_v1_dummy_proto_init() }
func file_devpod_experimental_v1_dummy_proto_init() {
	if File_devpod_experimental_v1_dummy_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_devpod_experimental_v1_dummy_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_experimental_v1_dummy_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_experimental_v1_dummy_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_experimental_v1_dummy_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_devpod_experimental_v1_dummy_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_devpod_experimental_v1_dummy_proto_goTypes,
		DependencyIndexes: file_devpod_experimental_v1_dummy_proto_depIdxs,
		MessageInfos:      file_devpod_experimental_v1_dummy_proto_msgTypes,
	}.Build()
	File_devpod_experimental_v1_dummy_proto = out.File
	file_devpod_experimental_v1_dummy_proto_rawDesc = nil
	file_devpod_experimental_v1_dummy_proto_goTypes = nil
	file_devpod_experimental_v1_dummy_proto_depIdxs = nil
}
