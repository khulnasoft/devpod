...
func (EditorOption_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_devpod_experimental_v1_editor_service_proto_enumTypes[0].Descriptor()
}

func (EditorOption_Type) Type() protoreflect.EnumType {
	return &file_devpod_experimental_v1_editor_service_proto_enumTypes[0]
}
...
func (EditorOption_Type) EnumDescriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_editor_service_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *ListEditorOptionsRequest) Reset() {
	*x = ListEditorOptionsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_editor_service_proto_msgTypes[0]
...
func (*ListEditorOptionsRequest) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_editor_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListEditorOptionsResponse) Reset() {
	*x = ListEditorOptionsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_editor_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListEditorOptionsResponse) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_editor_service_proto_rawDescGZIP(), []int{1}
}
...
type EditorOption struct {
	...
	Type  EditorOption_Type `protobuf:"varint,3,opt,name=type,proto3,enum=devpod.experimental.v1.EditorOption_Type" json:"type,omitempty"`
...
func (x *EditorOption) Reset() {
	*x = EditorOption{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_editor_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EditorOption) Descriptor() ([]byte, []int) {
	return file_devpod_experimental_v1_editor_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *EditorOption_Kind) Reset() {
	*x = EditorOption_Kind{}
	if protoimpl.UnsafeEnabled {
		mi := &file_devpod_experimental_v1_editor_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var File_devpod_experimental_v1_editor_service_proto protoreflect.FileDescriptor

var file_devpod_experimental_v1_editor_service_proto_rawDesc = []byte{
...
var (
	file_devpod_experimental_v1_editor_service_proto_rawDescOnce sync.Once
	file_devpod_experimental_v1_editor_service_proto_rawDescData = file_devpod_experimental_v1_editor_service_proto_rawDesc
)

func file_devpod_experimental_v1_editor_service_proto_rawDescGZIP() []byte {
	file_devpod_experimental_v1_editor_service_proto_rawDescOnce.Do(func() {
		file_devpod_experimental_v1_editor_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_devpod_experimental_v1_editor_service_proto_rawDescData)
	})
	return file_devpod_experimental_v1_editor_service_proto_rawDescData
}

var file_devpod_experimental_v1_editor_service_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_devpod_experimental_v1_editor_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_devpod_experimental_v1_editor_service_proto_goTypes = []interface{}{
	(EditorOption_Type)(0),            // 0: devpod.experimental.v1.EditorOption.Type
	(*ListEditorOptionsRequest)(nil),  // 1: devpod.experimental.v1.ListEditorOptionsRequest
	(*ListEditorOptionsResponse)(nil), // 2: devpod.experimental.v1.ListEditorOptionsResponse
	(*EditorOption)(nil),              // 3: devpod.experimental.v1.EditorOption
	(*EditorOption_Kind)(nil),         // 4: devpod.experimental.v1.EditorOption.Kind
}
var file_devpod_experimental_v1_editor_service_proto_depIdxs = []int32{
	3, // 0: devpod.experimental.v1.ListEditorOptionsResponse.result:type_name -> devpod.experimental.v1.EditorOption
	0, // 1: devpod.experimental.v1.EditorOption.type:type_name -> devpod.experimental.v1.EditorOption.Type
	4, // 2: devpod.experimental.v1.EditorOption.stable:type_name -> devpod.experimental.v1.EditorOption.Kind
	4, // 3: devpod.experimental.v1.EditorOption.latest:type_name -> devpod.experimental.v1.EditorOption.Kind
	1, // 4: devpod.experimental.v1.EditorService.ListEditorOptions:input_type -> devpod.experimental.v1.ListEditorOptionsRequest
	2, // 5: devpod.experimental.v1.EditorService.ListEditorOptions:output_type -> devpod.experimental.v1.ListEditorOptionsResponse
...
func init() { file_devpod_experimental_v1_editor_service_proto_init() }
func file_devpod_experimental_v1_editor_service_proto_init() {
	if File_devpod_experimental_v1_editor_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_devpod_experimental_v1_editor_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_experimental_v1_editor_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_experimental_v1_editor_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_devpod_experimental_v1_editor_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_devpod_experimental_v1_editor_service_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_devpod_experimental_v1_editor_service_proto_goTypes,
		DependencyIndexes: file_devpod_experimental_v1_editor_service_proto_depIdxs,
		EnumInfos:         file_devpod_experimental_v1_editor_service_proto_enumTypes,
		MessageInfos:      file_devpod_experimental_v1_editor_service_proto_msgTypes,
	}.Build()
	File_devpod_experimental_v1_editor_service_proto = out.File
	file_devpod_experimental_v1_editor_service_proto_rawDesc = nil
	file_devpod_experimental_v1_editor_service_proto_goTypes = nil
	file_devpod_experimental_v1_editor_service_proto_depIdxs = nil
}
