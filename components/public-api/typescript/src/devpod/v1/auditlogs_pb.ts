...
// @generated from file devpod/v1/auditlogs.proto (package devpod.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message devpod.v1.ListAuditLogsRequest
 */
export class ListAuditLogsRequest extends Message<ListAuditLogsRequest> {
  ...
  static readonly typeName = "devpod.v1.ListAuditLogsRequest";
...
/**
 * @generated from message devpod.v1.ListAuditLogsResponse
 */
export class ListAuditLogsResponse extends Message<ListAuditLogsResponse> {
   ...
   *
   * @generated from field: repeated devpod.v1.AuditLog audit_logs = 2;
   */
  auditLogs: AuditLog[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.ListAuditLogsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * typescript shape:
 *
 * @generated from message devpod.v1.AuditLog
 */
export class AuditLog extends Message<AuditLog> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.AuditLog";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
