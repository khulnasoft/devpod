...
/**
 * @generated from message devpod.v1.CreateTemporaryAccessTokenRequest
 */
export class CreateTemporaryAccessTokenRequest extends Message<CreateTemporaryAccessTokenRequest> {
  ...
  static readonly typeName = "devpod.v1.CreateTemporaryAccessTokenRequest";
...
/**
 * @generated from message devpod.v1.CreateTemporaryAccessTokenResponse
 */
export class CreateTemporaryAccessTokenResponse extends Message<CreateTemporaryAccessTokenResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.CreateTemporaryAccessTokenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
