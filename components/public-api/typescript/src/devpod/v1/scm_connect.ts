...
/**
 * @generated from service devpod.v1.SCMService
 */
export const SCMService = {
  typeName: "devpod.v1.SCMService",
  methods: {
    /**
     * SearchSCMTokens allows clients to retrieve SCM tokens based on the
     * specified host.
     *
     * @generated from rpc devpod.v1.SCMService.SearchSCMTokens
     */
    searchSCMTokens: {
     ...
     *
     * @generated from rpc devpod.v1.SCMService.GuessTokenScopes
     */
    guessTokenScopes: {
     ...
     *
     * @generated from rpc devpod.v1.SCMService.SearchRepositories
     */
    searchRepositories: {
     ...
     *
     * @generated from rpc devpod.v1.SCMService.ListSuggestedRepositories
     */
