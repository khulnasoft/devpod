...
// @generated from file devpod/v1/authprovider.proto (package devpod.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum devpod.v1.AuthProviderType
 */
...
proto3.util.setEnumType(AuthProviderType, "devpod.v1.AuthProviderType", [
...
/**
 * @generated from message devpod.v1.CreateAuthProviderRequest
 */
export class CreateAuthProviderRequest extends Message<CreateAuthProviderRequest> {
  /**
   * @generated from oneof devpod.v1.CreateAuthProviderRequest.owner
   */
  owner: {
    /**
  ...
  /**
   * @generated from field: devpod.v1.AuthProviderType type = 3;
   */
  ...
  /**
   * @generated from field: devpod.v1.OAuth2Config oauth2_config = 5;
   */
  ...
  static readonly typeName = "devpod.v1.CreateAuthProviderRequest";
...
/**
 * @generated from message devpod.v1.CreateAuthProviderResponse
 */
export class CreateAuthProviderResponse extends Message<CreateAuthProviderResponse> {
  /**
   * @generated from field: devpod.v1.AuthProvider auth_provider = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.CreateAuthProviderResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.GetAuthProviderRequest
 */
export class GetAuthProviderRequest extends Message<GetAuthProviderRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.GetAuthProviderRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.GetAuthProviderResponse
 */
export class GetAuthProviderResponse extends Message<GetAuthProviderResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.GetAuthProviderResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "auth_provider", kind: "message", T: AuthProvider },
  ]);
...
/**
 * @generated from message devpod.v1.ListAuthProvidersRequest
 */
export class ListAuthProvidersRequest extends Message<ListAuthProvidersRequest> {
  ...
  /**
   * @generated from oneof devpod.v1.ListAuthProvidersRequest.id
   */
  id: {
    /**
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.ListAuthProvidersRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.ListAuthProvidersResponse
 */
export class ListAuthProvidersResponse extends Message<ListAuthProvidersResponse> {
  /**
   * @generated from field: repeated devpod.v1.AuthProvider auth_providers = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.ListAuthProvidersResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.ListAuthProviderDescriptionsRequest
 */
export class ListAuthProviderDescriptionsRequest extends Message<ListAuthProviderDescriptionsRequest> {
  ...
  /**
   * @generated from oneof devpod.v1.ListAuthProviderDescriptionsRequest.id
   */
  id: {
    /**
     * @generated from field: string user_id = 2;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.ListAuthProviderDescriptionsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "pagination", kind: "message", T: PaginationRequest },
    { no: 2, name: "user_id", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "id" },
    { no: 3, name: "organization_id", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "id" },
...
/**
 * @generated from message devpod.v1.ListAuthProviderDescriptionsResponse
 */
export class ListAuthProviderDescriptionsResponse extends Message<ListAuthProviderDescriptionsResponse> {
  /**
   * @generated from field: repeated devpod.v1.AuthProviderDescription descriptions = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.ListAuthProviderDescriptionsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.UpdateAuthProviderRequest
 */
export class UpdateAuthProviderRequest extends Message<UpdateAuthProviderRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.UpdateAuthProviderRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "auth_provider_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message devpod.v1.UpdateAuthProviderResponse
 */
export class UpdateAuthProviderResponse extends Message<UpdateAuthProviderResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.UpdateAuthProviderResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "auth_provider", kind: "message", T: AuthProvider },
  ]);
...
/**
 * @generated from message devpod.v1.DeleteAuthProviderRequest
 */
export class DeleteAuthProviderRequest extends Message<DeleteAuthProviderRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.DeleteAuthProviderRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "auth_provider_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message devpod.v1.DeleteAuthProviderResponse
 */
export class DeleteAuthProviderResponse extends Message<DeleteAuthProviderResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.DeleteAuthProviderResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devpod.v1.AuthProviderDescription
 */
export class AuthProviderDescription extends Message<AuthProviderDescription> {
  ...
  /**
   * @generated from field: devpod.v1.AuthProviderType type = 4;
   */
  type = AuthProviderType.UNSPECIFIED;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.AuthProviderDescription";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.AuthProvider
 */
export class AuthProvider extends Message<AuthProvider> {
  ...
  /**
   * @generated from oneof devpod.v1.AuthProvider.owner
   */
  owner: {
    /**
  ...
  /**
   * @generated from field: devpod.v1.OAuth2Config oauth2_config = 12;
   */
  oauth2Config?: OAuth2Config;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.AuthProvider";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message devpod.v1.OAuth2Config
 */
export class OAuth2Config extends Message<OAuth2Config> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.OAuth2Config";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
