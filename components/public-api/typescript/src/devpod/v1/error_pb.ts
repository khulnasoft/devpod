...
// @generated from file devpod/v1/error.proto (package devpod.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message devpod.v1.PermissionDeniedDetails
 */
export class PermissionDeniedDetails extends Message<PermissionDeniedDetails> {
  /**
   * @generated from oneof devpod.v1.PermissionDeniedDetails.reason
   */
  reason: {
    /**
     * @generated from field: devpod.v1.UserBlockedError user_blocked = 1;
     */
    value: UserBlockedError;
    case: "userBlocked";
  } | {
    /**
     * @generated from field: devpod.v1.NeedsVerificationError needs_verification = 2;
     */
  ...
  static readonly typeName = "devpod.v1.PermissionDeniedDetails";
...
/**
 * @generated from message devpod.v1.UserBlockedError
 */
export class UserBlockedError extends Message<UserBlockedError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.UserBlockedError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devpod.v1.NeedsVerificationError
 */
export class NeedsVerificationError extends Message<NeedsVerificationError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.NeedsVerificationError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message devpod.v1.FailedPreconditionDetails
 */
export class FailedPreconditionDetails extends Message<FailedPreconditionDetails> {
  /**
   * @generated from oneof devpod.v1.FailedPreconditionDetails.reason
   */
  reason: {
    /**
     * @generated from field: devpod.v1.PaymentSpendingLimitReachedError payment_spending_limit_reached = 1;
     */
    value: PaymentSpendingLimitReachedError;
    case: "paymentSpendingLimitReached";
  } | {
    /**
     * @generated from field: devpod.v1.InvalidCostCenterError invalid_cost_center = 2;
     */
    value: InvalidCostCenterError;
    case: "invalidCostCenter";
  } | {
    /**
     * @generated from field: devpod.v1.TooManyRunningWorkspacesError too_many_running_workspaces = 3;
     */
    ...
    /**
     * @generated from field: devpod.v1.RepositoryUnauthorizedError repository_unauthorized = 6;
     */
    value: RepositoryUnauthorizedError;
    case: "repositoryUnauthorized";
  } | {
    /**
     * @generated from field: devpod.v1.ImageBuildLogsNotYetAvailableError image_build_logs_not_yet_available = 7;
     */
    value: ImageBuildLogsNotYetAvailableError;
    case: "imageBuildLogsNotYetAvailable";
  } | {
    /**
     * @generated from field: devpod.v1.CellDisabledError cell_is_disabled = 8;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.FailedPreconditionDetails";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.PaymentSpendingLimitReachedError
 */
export class PaymentSpendingLimitReachedError extends Message<PaymentSpendingLimitReachedError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.PaymentSpendingLimitReachedError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devpod.v1.InvalidCostCenterError
 */
export class InvalidCostCenterError extends Message<InvalidCostCenterError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.InvalidCostCenterError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.TooManyRunningWorkspacesError
 */
export class TooManyRunningWorkspacesError extends Message<TooManyRunningWorkspacesError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.TooManyRunningWorkspacesError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devpod.v1.RepositoryNotFoundError
 */
export class RepositoryNotFoundError extends Message<RepositoryNotFoundError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.RepositoryNotFoundError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.RepositoryUnauthorizedError
 */
export class RepositoryUnauthorizedError extends Message<RepositoryUnauthorizedError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.RepositoryUnauthorizedError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "host", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message devpod.v1.ImageBuildLogsNotYetAvailableError
 */
export class ImageBuildLogsNotYetAvailableError extends Message<ImageBuildLogsNotYetAvailableError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.ImageBuildLogsNotYetAvailableError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devpod.v1.CellDisabledError
 */
export class CellDisabledError extends Message<CellDisabledError> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.CellDisabledError";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
