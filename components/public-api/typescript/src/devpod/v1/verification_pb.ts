 ...
 * - phone_number
 *
 * @generated from message devpod.v1.SendPhoneNumberVerificationTokenRequest
 */
export class SendPhoneNumberVerificationTokenRequest extends Message<SendPhoneNumberVerificationTokenRequest> {
  ...
  static readonly typeName = "devpod.v1.SendPhoneNumberVerificationTokenRequest";
...
/**
 * @generated from message devpod.v1.SendPhoneNumberVerificationTokenResponse
 */
export class SendPhoneNumberVerificationTokenResponse extends Message<SendPhoneNumberVerificationTokenResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.SendPhoneNumberVerificationTokenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * - token
 *
 * @generated from message devpod.v1.VerifyPhoneNumberVerificationTokenRequest
 */
export class VerifyPhoneNumberVerificationTokenRequest extends Message<VerifyPhoneNumberVerificationTokenRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.VerifyPhoneNumberVerificationTokenRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "phone_number", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message devpod.v1.VerifyPhoneNumberVerificationTokenResponse
 */
export class VerifyPhoneNumberVerificationTokenResponse extends Message<VerifyPhoneNumberVerificationTokenResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.VerifyPhoneNumberVerificationTokenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
