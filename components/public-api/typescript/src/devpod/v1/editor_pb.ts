...
// @generated from file devpod/v1/editor.proto (package devpod.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message devpod.v1.EditorReference
 */
export class EditorReference extends Message<EditorReference> {
  ...
  static readonly typeName = "devpod.v1.EditorReference";
