...
/**
 * @generated from message devpod.v1.GetPrebuildRequest
 */
export class GetPrebuildRequest extends Message<GetPrebuildRequest> {
  ...
  static readonly typeName = "devpod.v1.GetPrebuildRequest";
...
/**
 * @generated from message devpod.v1.GetPrebuildResponse
 */
export class GetPrebuildResponse extends Message<GetPrebuildResponse> {
  /**
   * @generated from field: devpod.v1.Prebuild prebuild = 1;
   */
  prebuild?: Prebuild;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.GetPrebuildResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.ListPrebuildsRequest
 */
export class ListPrebuildsRequest extends Message<ListPrebuildsRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.ListPrebuildsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.ListPrebuildsResponse
 */
export class ListPrebuildsResponse extends Message<ListPrebuildsResponse> {
  ...
  /**
   * @generated from field: repeated devpod.v1.Prebuild prebuilds = 2;
   */
  prebuilds: Prebuild[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.ListPrebuildsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.StartPrebuildRequest
 */
export class StartPrebuildRequest extends Message<StartPrebuildRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.StartPrebuildRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.StartPrebuildResponse
 */
export class StartPrebuildResponse extends Message<StartPrebuildResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.StartPrebuildResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "prebuild_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message devpod.v1.CancelPrebuildRequest
 */
export class CancelPrebuildRequest extends Message<CancelPrebuildRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.CancelPrebuildRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "prebuild_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message devpod.v1.CancelPrebuildResponse
 */
export class CancelPrebuildResponse extends Message<CancelPrebuildResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.CancelPrebuildResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devpod.v1.WatchPrebuildRequest
 */
export class WatchPrebuildRequest extends Message<WatchPrebuildRequest> {
  /**
   * @generated from oneof devpod.v1.WatchPrebuildRequest.scope
   */
  scope: {
    /**
     * @generated from field: string prebuild_id = 1;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.WatchPrebuildRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.WatchPrebuildResponse
 */
export class WatchPrebuildResponse extends Message<WatchPrebuildResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.WatchPrebuildResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "prebuild", kind: "message", T: Prebuild },
  ]);
...
/**
 * @generated from message devpod.v1.ListOrganizationPrebuildsRequest
 */
export class ListOrganizationPrebuildsRequest extends Message<ListOrganizationPrebuildsRequest> {
  ...
  /**
   * @generated from field: devpod.v1.ListOrganizationPrebuildsRequest.Filter filter = 3;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.ListOrganizationPrebuildsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "pagination", kind: "message", T: PaginationRequest },
...
/**
 * @generated from message devpod.v1.ListOrganizationPrebuildsRequest.Filter
 */
export class ListOrganizationPrebuildsRequest_Filter extends Message<ListOrganizationPrebuildsRequest_Filter> {
  /**
   * @generated from field: devpod.v1.ListOrganizationPrebuildsRequest.Filter.State state = 1;
   */
  state = ListOrganizationPrebuildsRequest_Filter_State.UNSPECIFIED;

  /**
   * @generated from field: devpod.v1.ListOrganizationPrebuildsRequest.Filter.Configuration configuration = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.ListOrganizationPrebuildsRequest.Filter";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum devpod.v1.ListOrganizationPrebuildsRequest.Filter.State
 */
...
proto3.util.setEnumType(ListOrganizationPrebuildsRequest_Filter_State, "devpod.v1.ListOrganizationPrebuildsRequest.Filter.State", [
...
/**
 * @generated from message devpod.v1.ListOrganizationPrebuildsRequest.Filter.Configuration
 */
export class ListOrganizationPrebuildsRequest_Filter_Configuration extends Message<ListOrganizationPrebuildsRequest_Filter_Configuration> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.ListOrganizationPrebuildsRequest.Filter.Configuration";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.ListOrganizationPrebuildsResponse
 */
export class ListOrganizationPrebuildsResponse extends Message<ListOrganizationPrebuildsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.ListOrganizationPrebuildsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "pagination", kind: "message", T: PaginationResponse },
    { no: 2, name: "prebuilds", kind: "message", T: Prebuild, repeated: true },
  ]);
...
/**
 * @generated from message devpod.v1.Prebuild
 */
export class Prebuild extends Message<Prebuild> {
  ...
  /**
   * @generated from field: devpod.v1.Commit commit = 6;
   */
  commit?: Commit;
  ...
  /**
   * @generated from field: devpod.v1.PrebuildStatus status = 8;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.Prebuild";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "workspace_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message devpod.v1.PrebuildStatus
 */
export class PrebuildStatus extends Message<PrebuildStatus> {
  /**
   * @generated from field: devpod.v1.PrebuildPhase phase = 1;
   */
  phase?: PrebuildPhase;
  ...
  /**
   * @generated from field: repeated devpod.v1.TaskLog task_logs = 5;
   */
  taskLogs: TaskLog[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.PrebuildStatus";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.TaskLog
 */
export class TaskLog extends Message<TaskLog> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.TaskLog";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.v1.PrebuildPhase
 */
export class PrebuildPhase extends Message<PrebuildPhase> {
  /**
   * @generated from field: devpod.v1.PrebuildPhase.Phase name = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.v1.PrebuildPhase";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum devpod.v1.PrebuildPhase.Phase
 */
...
proto3.util.setEnumType(PrebuildPhase_Phase, "devpod.v1.PrebuildPhase.Phase", [
