...
// @generated from file devpod/experimental/v1/editor_service.proto (package devpod.experimental.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message devpod.experimental.v1.ListEditorOptionsRequest
 */
export class ListEditorOptionsRequest extends Message<ListEditorOptionsRequest> {
  ...
  static readonly typeName = "devpod.experimental.v1.ListEditorOptionsRequest";
...
/**
 * @generated from message devpod.experimental.v1.ListEditorOptionsResponse
 */
export class ListEditorOptionsResponse extends Message<ListEditorOptionsResponse> {
  /**
   * @generated from field: repeated devpod.experimental.v1.EditorOption result = 1;
   */
  result: EditorOption[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.ListEditorOptionsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.experimental.v1.EditorOption
 */
export class EditorOption extends Message<EditorOption> {
  ...
  /**
   * @generated from field: devpod.experimental.v1.EditorOption.Type type = 3;
   */
  ...
  /**
   * @generated from field: devpod.experimental.v1.EditorOption.Kind stable = 6;
   */
  stable?: EditorOption_Kind;

  /**
   * @generated from field: devpod.experimental.v1.EditorOption.Kind latest = 7;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.EditorOption";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from enum devpod.experimental.v1.EditorOption.Type
 */
...
proto3.util.setEnumType(EditorOption_Type, "devpod.experimental.v1.EditorOption.Type", [
...
/**
 * @generated from message devpod.experimental.v1.EditorOption.Kind
 */
export class EditorOption_Kind extends Message<EditorOption_Kind> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.EditorOption.Kind";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
