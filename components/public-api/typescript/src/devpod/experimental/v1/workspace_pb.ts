...
// @generated from file devpod/experimental/v1/workspace.proto (package devpod.experimental.v1, syntax proto3)
/* eslint-disable */
/* @ts-nocheck */
...
/**
 * @generated from enum devpod.experimental.v1.PortVisibility
 */
...
proto3.util.setEnumType(PortVisibility, "devpod.experimental.v1.PortVisibility", [
...
/**
 * @generated from message devpod.experimental.v1.OpenPortRequest
 */
export class OpenPortRequest extends Message<OpenPortRequest> {
    ...
    static readonly typeName = "devpod.experimental.v1.OpenPortRequest";
...
/**
 * @generated from message devpod.experimental.v1.OpenPortResponse
 */
export class OpenPortResponse extends Message<OpenPortResponse> {
    /**
     * @generated from field: devpod.experimental.v1.WorkspaceInstancePort port = 1;
     */
    ...
    static readonly runtime = proto3;
    static readonly typeName = "devpod.experimental.v1.OpenPortResponse";
    static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.experimental.v1.WorkspaceInstancePort
 */
export class WorkspaceInstancePort extends Message<WorkspaceInstancePort> {
    ...
    /**
     * @generated from field: devpod.experimental.v1.PortVisibility visibility = 3;
     */
    ...
    static readonly runtime = proto3;
    static readonly typeName = "devpod.experimental.v1.WorkspaceInstancePort";
    static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.experimental.v1.GetOpenPortsRequest
 */
export class GetOpenPortsRequest extends Message<GetOpenPortsRequest> {
    ...
    static readonly runtime = proto3;
    static readonly typeName = "devpod.experimental.v1.GetOpenPortsRequest";
    static readonly fields: FieldList = proto3.util.newFieldList(() => [
        { no: 1, name: "workspace_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    ]);
...
/**
 * @generated from message devpod.experimental.v1.GetOpenPortsResponse
 */
export class GetOpenPortsResponse extends Message<GetOpenPortsResponse> {
    /**
     * @generated from field: repeated devpod.experimental.v1.WorkspaceInstancePort ports = 1;
     */
    ...
    static readonly runtime = proto3;
    static readonly typeName = "devpod.experimental.v1.GetOpenPortsResponse";
    static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.experimental.v1.InstanceUpdatesRequest
 */
export class InstanceUpdatesRequest extends Message<InstanceUpdatesRequest> {
    ...
    static readonly runtime = proto3;
    static readonly typeName = "devpod.experimental.v1.InstanceUpdatesRequest";
    static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.experimental.v1.InstanceUpdatesResponse
 */
export class InstanceUpdatesResponse extends Message<InstanceUpdatesResponse> {
    ...
    static readonly runtime = proto3;
    static readonly typeName = "devpod.experimental.v1.InstanceUpdatesResponse";
    static readonly fields: FieldList = proto3.util.newFieldList(() => [
