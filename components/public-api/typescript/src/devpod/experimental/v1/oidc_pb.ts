...
// @generated from file devpod/experimental/v1/oidc.proto (package devpod.experimental.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message devpod.experimental.v1.OIDCClientConfig
 */
export class OIDCClientConfig extends Message<OIDCClientConfig> {
  ...
  /**
   * @generated from field: devpod.experimental.v1.OIDCConfig oidc_config = 3;
   */
  oidcConfig?: OIDCConfig;

  /**
   * @generated from field: devpod.experimental.v1.OAuth2Config oauth2_config = 4;
   */
   ...
   * Read-only.
   *
   * @generated from field: devpod.experimental.v1.OIDCClientConfigStatus status = 8;
   */
  ...
  static readonly typeName = "devpod.experimental.v1.OIDCClientConfig";
 ...
 *
 * @generated from message devpod.experimental.v1.OIDCConfig
 */
export class OIDCConfig extends Message<OIDCConfig> {
   ...
   * Optional.
   *
   * @generated from field: devpod.experimental.v1.ConsentScreenHints hints = 4;
   */
   ...
   * Optional.
   *
   * @generated from field: devpod.experimental.v1.ClaimMappingOverride override_claim_mapping = 5;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.OIDCConfig";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * Provider specific parameters to control the behavior of the consent screen.
 *
 * @generated from message devpod.experimental.v1.ConsentScreenHints
 */
export class ConsentScreenHints extends Message<ConsentScreenHints> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.ConsentScreenHints";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * Optional overrides for key mapping to be applied when extracting claims from id_tokens.
 *
 * @generated from message devpod.experimental.v1.ClaimMappingOverride
 */
export class ClaimMappingOverride extends Message<ClaimMappingOverride> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.ClaimMappingOverride";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message devpod.experimental.v1.OAuth2Config
 */
export class OAuth2Config extends Message<OAuth2Config> {
   ...
   * Optional.
   *
   * @generated from field: devpod.experimental.v1.UserInfoKeys userinfo_keys = 7;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.OAuth2Config";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message devpod.experimental.v1.UserInfoKeys
 */
export class UserInfoKeys extends Message<UserInfoKeys> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.UserInfoKeys";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message devpod.experimental.v1.OIDCClientConfigStatus
 */
export class OIDCClientConfigStatus extends Message<OIDCClientConfigStatus> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.OIDCClientConfigStatus";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devpod.experimental.v1.CreateClientConfigRequest
 */
export class CreateClientConfigRequest extends Message<CreateClientConfigRequest> {
  /**
   * @generated from field: devpod.experimental.v1.OIDCClientConfig config = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.CreateClientConfigRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.experimental.v1.CreateClientConfigResponse
 */
export class CreateClientConfigResponse extends Message<CreateClientConfigResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.CreateClientConfigResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "config", kind: "message", T: OIDCClientConfig },
  ]);
...
/**
 * @generated from message devpod.experimental.v1.GetClientConfigRequest
 */
export class GetClientConfigRequest extends Message<GetClientConfigRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.GetClientConfigRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "organization_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message devpod.experimental.v1.GetClientConfigResponse
 */
export class GetClientConfigResponse extends Message<GetClientConfigResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.GetClientConfigResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "config", kind: "message", T: OIDCClientConfig },
  ]);
...
/**
 * @generated from message devpod.experimental.v1.ListClientConfigsRequest
 */
export class ListClientConfigsRequest extends Message<ListClientConfigsRequest> {
   ...
   * Page information
   *
   * @generated from field: devpod.experimental.v1.Pagination pagination = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.ListClientConfigsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.experimental.v1.ListClientConfigsResponse
 */
export class ListClientConfigsResponse extends Message<ListClientConfigsResponse> {
  /**
   * @generated from field: repeated devpod.experimental.v1.OIDCClientConfig client_configs = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.ListClientConfigsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.experimental.v1.UpdateClientConfigRequest
 */
export class UpdateClientConfigRequest extends Message<UpdateClientConfigRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.UpdateClientConfigRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "config", kind: "message", T: OIDCClientConfig },
  ]);
...
/**
 * @generated from message devpod.experimental.v1.UpdateClientConfigResponse
 */
export class UpdateClientConfigResponse extends Message<UpdateClientConfigResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.UpdateClientConfigResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devpod.experimental.v1.DeleteClientConfigRequest
 */
export class DeleteClientConfigRequest extends Message<DeleteClientConfigRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.DeleteClientConfigRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "organization_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message devpod.experimental.v1.DeleteClientConfigResponse
 */
export class DeleteClientConfigResponse extends Message<DeleteClientConfigResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.DeleteClientConfigResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message devpod.experimental.v1.SetClientConfigActivationRequest
 */
export class SetClientConfigActivationRequest extends Message<SetClientConfigActivationRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.SetClientConfigActivationRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "organization_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message devpod.experimental.v1.SetClientConfigActivationResponse
 */
export class SetClientConfigActivationResponse extends Message<SetClientConfigActivationResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.SetClientConfigActivationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
