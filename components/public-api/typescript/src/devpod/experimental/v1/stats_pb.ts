...
/**
 * @generated from message devpod.experimental.v1.GetUserStatsRequest
 */
export class GetUserStatsRequest extends Message<GetUserStatsRequest> {
  ...
  static readonly typeName = "devpod.experimental.v1.GetUserStatsRequest";
...
/**
 * @generated from message devpod.experimental.v1.GetUserStatsResponse
 */
export class GetUserStatsResponse extends Message<GetUserStatsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.GetUserStatsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
