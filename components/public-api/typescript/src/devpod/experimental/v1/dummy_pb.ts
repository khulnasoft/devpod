...
// @generated from file devpod/experimental/v1/dummy.proto (package devpod.experimental.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message devpod.experimental.v1.SayHelloRequest
 */
export class SayHelloRequest extends Message<SayHelloRequest> {
  ...
  static readonly typeName = "devpod.experimental.v1.SayHelloRequest";
...
/**
 * @generated from message devpod.experimental.v1.SayHelloResponse
 */
export class SayHelloResponse extends Message<SayHelloResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.SayHelloResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.experimental.v1.LotsOfRepliesRequest
 */
export class LotsOfRepliesRequest extends Message<LotsOfRepliesRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.LotsOfRepliesRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message devpod.experimental.v1.LotsOfRepliesResponse
 */
export class LotsOfRepliesResponse extends Message<LotsOfRepliesResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "devpod.experimental.v1.LotsOfRepliesResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "reply", kind: "scalar", T: 9 /* ScalarType.STRING */ },
