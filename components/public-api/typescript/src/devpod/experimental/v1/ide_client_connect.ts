...
/**
 * @generated from service devpod.experimental.v1.IDEClientService
 */
export const IDEClientService = {
  typeName: "devpod.experimental.v1.IDEClientService",
  methods: {
    /**
     * SendHeartbeat sends a clientheartbeat signal for a running workspace.
     *
     * @generated from rpc devpod.experimental.v1.IDEClientService.SendHeartbeat
     */
    sendHeartbeat: {
      name: "SendHeartbeat",
     ...
     *
     * @generated from rpc devpod.experimental.v1.IDEClientService.SendDidClose
     */
    sendDidClose: {
      name: "SendDidClose",
     ...
     *
     * @generated from rpc devpod.experimental.v1.IDEClientService.UpdateGitStatus
     */
    updateGitStatus: {
