...
public class IDEClientServiceClient(
  ...
  override suspend fun sendHeartbeat(request: IdeClient.SendHeartbeatRequest, headers: Headers):
    ...
    "devpod.experimental.v1.IDEClientService/SendHeartbeat",
      io.devpod.publicapi.experimental.v1.IdeClient.SendHeartbeatRequest::class,
      io.devpod.publicapi.experimental.v1.IdeClient.SendHeartbeatResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun sendDidClose(request: IdeClient.SendDidCloseRequest, headers: Headers):
    ...
    "devpod.experimental.v1.IDEClientService/SendDidClose",
      io.devpod.publicapi.experimental.v1.IdeClient.SendDidCloseRequest::class,
      io.devpod.publicapi.experimental.v1.IdeClient.SendDidCloseResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateGitStatus(request: IdeClient.UpdateGitStatusRequest, headers: Headers):
    ...
    "devpod.experimental.v1.IDEClientService/UpdateGitStatus",
      io.devpod.publicapi.experimental.v1.IdeClient.UpdateGitStatusRequest::class,
      io.devpod.publicapi.experimental.v1.IdeClient.UpdateGitStatusResponse::class,
      StreamType.UNARY,
    ),
  )
