...
public class UserServiceClient(
  ...
  override suspend fun getAuthenticatedUser(request: UserOuterClass.GetAuthenticatedUserRequest,
    ...
    "devpod.v1.UserService/GetAuthenticatedUser",
      io.devpod.publicapi.v1.UserOuterClass.GetAuthenticatedUserRequest::class,
      io.devpod.publicapi.v1.UserOuterClass.GetAuthenticatedUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateUser(request: UserOuterClass.UpdateUserRequest, headers: Headers):
    ...
    "devpod.v1.UserService/UpdateUser",
      io.devpod.publicapi.v1.UserOuterClass.UpdateUserRequest::class,
      io.devpod.publicapi.v1.UserOuterClass.UpdateUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.UserService/SetWorkspaceAutoStartOptions",
      io.devpod.publicapi.v1.UserOuterClass.SetWorkspaceAutoStartOptionsRequest::class,
      io.devpod.publicapi.v1.UserOuterClass.SetWorkspaceAutoStartOptionsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteUser(request: UserOuterClass.DeleteUserRequest, headers: Headers):
    ...
    "devpod.v1.UserService/DeleteUser",
      io.devpod.publicapi.v1.UserOuterClass.DeleteUserRequest::class,
      io.devpod.publicapi.v1.UserOuterClass.DeleteUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun verifyUser(request: UserOuterClass.VerifyUserRequest, headers: Headers):
    ...
    "devpod.v1.UserService/VerifyUser",
      io.devpod.publicapi.v1.UserOuterClass.VerifyUserRequest::class,
      io.devpod.publicapi.v1.UserOuterClass.VerifyUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun blockUser(request: UserOuterClass.BlockUserRequest, headers: Headers):
    ...
    "devpod.v1.UserService/BlockUser",
      io.devpod.publicapi.v1.UserOuterClass.BlockUserRequest::class,
      io.devpod.publicapi.v1.UserOuterClass.BlockUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listUsers(request: UserOuterClass.ListUsersRequest, headers: Headers):
    ...
    "devpod.v1.UserService/ListUsers",
      io.devpod.publicapi.v1.UserOuterClass.ListUsersRequest::class,
      io.devpod.publicapi.v1.UserOuterClass.ListUsersResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getUser(request: UserOuterClass.GetUserRequest, headers: Headers):
    ...
    "devpod.v1.UserService/GetUser",
      io.devpod.publicapi.v1.UserOuterClass.GetUserRequest::class,
      io.devpod.publicapi.v1.UserOuterClass.GetUserResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun setRolesOrPermissions(request: UserOuterClass.SetRolesOrPermissionsRequest,
    ...
    "devpod.v1.UserService/SetRolesOrPermissions",
      io.devpod.publicapi.v1.UserOuterClass.SetRolesOrPermissionsRequest::class,
      io.devpod.publicapi.v1.UserOuterClass.SetRolesOrPermissionsResponse::class,
      StreamType.UNARY,
    ),
  )
