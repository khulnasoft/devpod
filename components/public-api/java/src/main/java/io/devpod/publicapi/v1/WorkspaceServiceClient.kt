...
public class WorkspaceServiceClient(
  ...
  override suspend fun getWorkspace(request: WorkspaceOuterClass.GetWorkspaceRequest,
    ...
    "devpod.v1.WorkspaceService/GetWorkspace",
      io.devpod.publicapi.v1.WorkspaceOuterClass.GetWorkspaceRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.GetWorkspaceResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun watchWorkspaceStatus(headers: Headers):
    ...
    "devpod.v1.WorkspaceService/WatchWorkspaceStatus",
      io.devpod.publicapi.v1.WorkspaceOuterClass.WatchWorkspaceStatusRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.WatchWorkspaceStatusResponse::class,
      StreamType.SERVER,
    ),
  )
  ...
  override suspend fun listWorkspaces(request: WorkspaceOuterClass.ListWorkspacesRequest,
    ...
    "devpod.v1.WorkspaceService/ListWorkspaces",
      io.devpod.publicapi.v1.WorkspaceOuterClass.ListWorkspacesRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.ListWorkspacesResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.WorkspaceService/ListWorkspaceSessions",
      io.devpod.publicapi.v1.WorkspaceOuterClass.ListWorkspaceSessionsRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.ListWorkspaceSessionsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.WorkspaceService/CreateAndStartWorkspace",
      io.devpod.publicapi.v1.WorkspaceOuterClass.CreateAndStartWorkspaceRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.CreateAndStartWorkspaceResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun startWorkspace(request: WorkspaceOuterClass.StartWorkspaceRequest,
    ...
    "devpod.v1.WorkspaceService/StartWorkspace",
      io.devpod.publicapi.v1.WorkspaceOuterClass.StartWorkspaceRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.StartWorkspaceResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateWorkspace(request: WorkspaceOuterClass.UpdateWorkspaceRequest,
    ...
    "devpod.v1.WorkspaceService/UpdateWorkspace",
      io.devpod.publicapi.v1.WorkspaceOuterClass.UpdateWorkspaceRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.UpdateWorkspaceResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun stopWorkspace(request: WorkspaceOuterClass.StopWorkspaceRequest,
    ...
    "devpod.v1.WorkspaceService/StopWorkspace",
      io.devpod.publicapi.v1.WorkspaceOuterClass.StopWorkspaceRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.StopWorkspaceResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteWorkspace(request: WorkspaceOuterClass.DeleteWorkspaceRequest,
    ...
    "devpod.v1.WorkspaceService/DeleteWorkspace",
      io.devpod.publicapi.v1.WorkspaceOuterClass.DeleteWorkspaceRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.DeleteWorkspaceResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.WorkspaceService/ListWorkspaceClasses",
      io.devpod.publicapi.v1.WorkspaceOuterClass.ListWorkspaceClassesRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.ListWorkspaceClassesResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun parseContextURL(request: WorkspaceOuterClass.ParseContextURLRequest,
    ...
    "devpod.v1.WorkspaceService/ParseContextURL",
      io.devpod.publicapi.v1.WorkspaceOuterClass.ParseContextURLRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.ParseContextURLResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.WorkspaceService/GetWorkspaceDefaultImage",
      io.devpod.publicapi.v1.WorkspaceOuterClass.GetWorkspaceDefaultImageRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.GetWorkspaceDefaultImageResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun sendHeartBeat(request: WorkspaceOuterClass.SendHeartBeatRequest,
    ...
    "devpod.v1.WorkspaceService/SendHeartBeat",
      io.devpod.publicapi.v1.WorkspaceOuterClass.SendHeartBeatRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.SendHeartBeatResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.WorkspaceService/GetWorkspaceOwnerToken",
      io.devpod.publicapi.v1.WorkspaceOuterClass.GetWorkspaceOwnerTokenRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.GetWorkspaceOwnerTokenResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.WorkspaceService/GetWorkspaceEditorCredentials",
      io.devpod.publicapi.v1.WorkspaceOuterClass.GetWorkspaceEditorCredentialsRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.GetWorkspaceEditorCredentialsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.WorkspaceService/CreateWorkspaceSnapshot",
      io.devpod.publicapi.v1.WorkspaceOuterClass.CreateWorkspaceSnapshotRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.CreateWorkspaceSnapshotResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.WorkspaceService/WaitForWorkspaceSnapshot",
      io.devpod.publicapi.v1.WorkspaceOuterClass.WaitForWorkspaceSnapshotRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.WaitForWorkspaceSnapshotResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateWorkspacePort(request: WorkspaceOuterClass.UpdateWorkspacePortRequest,
    ...
    "devpod.v1.WorkspaceService/UpdateWorkspacePort",
      io.devpod.publicapi.v1.WorkspaceOuterClass.UpdateWorkspacePortRequest::class,
      io.devpod.publicapi.v1.WorkspaceOuterClass.UpdateWorkspacePortResponse::class,
      StreamType.UNARY,
    ),
  )
