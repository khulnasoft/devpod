...
public class SCMServiceClient(
  ...
  override suspend fun searchSCMTokens(request: Scm.SearchSCMTokensRequest, headers: Headers):
    ...
    "devpod.v1.SCMService/SearchSCMTokens",
      io.devpod.publicapi.v1.Scm.SearchSCMTokensRequest::class,
      io.devpod.publicapi.v1.Scm.SearchSCMTokensResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun guessTokenScopes(request: Scm.GuessTokenScopesRequest, headers: Headers):
    ...
    "devpod.v1.SCMService/GuessTokenScopes",
      io.devpod.publicapi.v1.Scm.GuessTokenScopesRequest::class,
      io.devpod.publicapi.v1.Scm.GuessTokenScopesResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun searchRepositories(request: Scm.SearchRepositoriesRequest, headers: Headers):
    ...
    "devpod.v1.SCMService/SearchRepositories",
      io.devpod.publicapi.v1.Scm.SearchRepositoriesRequest::class,
      io.devpod.publicapi.v1.Scm.SearchRepositoriesResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listSuggestedRepositories(request: Scm.ListSuggestedRepositoriesRequest,
    ...
    "devpod.v1.SCMService/ListSuggestedRepositories",
      io.devpod.publicapi.v1.Scm.ListSuggestedRepositoriesRequest::class,
      io.devpod.publicapi.v1.Scm.ListSuggestedRepositoriesResponse::class,
      StreamType.UNARY,
    ),
  )
