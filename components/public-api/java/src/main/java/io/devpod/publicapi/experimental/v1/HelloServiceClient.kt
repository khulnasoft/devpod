...
public class HelloServiceClient(
  ...
  override suspend fun sayHello(request: Dummy.SayHelloRequest, headers: Headers):
    ...
    "devpod.experimental.v1.HelloService/SayHello",
      io.devpod.publicapi.experimental.v1.Dummy.SayHelloRequest::class,
      io.devpod.publicapi.experimental.v1.Dummy.SayHelloResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun lotsOfReplies(headers: Headers):
    ...
    "devpod.experimental.v1.HelloService/LotsOfReplies",
      io.devpod.publicapi.experimental.v1.Dummy.LotsOfRepliesRequest::class,
      io.devpod.publicapi.experimental.v1.Dummy.LotsOfRepliesResponse::class,
      StreamType.SERVER,
    ),
  )
