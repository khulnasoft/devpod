...
public class InstallationServiceClient(
  ...
  override suspend
    ...
    "devpod.v1.InstallationService/GetInstallationWorkspaceDefaultImage",
      io.devpod.publicapi.v1.Installation.GetInstallationWorkspaceDefaultImageRequest::class,
      io.devpod.publicapi.v1.Installation.GetInstallationWorkspaceDefaultImageResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listBlockedRepositories(request: Installation.ListBlockedRepositoriesRequest,
    ...
    "devpod.v1.InstallationService/ListBlockedRepositories",
      io.devpod.publicapi.v1.Installation.ListBlockedRepositoriesRequest::class,
      io.devpod.publicapi.v1.Installation.ListBlockedRepositoriesResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun createBlockedRepository(request: Installation.CreateBlockedRepositoryRequest,
    ...
    "devpod.v1.InstallationService/CreateBlockedRepository",
      io.devpod.publicapi.v1.Installation.CreateBlockedRepositoryRequest::class,
      io.devpod.publicapi.v1.Installation.CreateBlockedRepositoryResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteBlockedRepository(request: Installation.DeleteBlockedRepositoryRequest,
    ...
    "devpod.v1.InstallationService/DeleteBlockedRepository",
      io.devpod.publicapi.v1.Installation.DeleteBlockedRepositoryRequest::class,
      io.devpod.publicapi.v1.Installation.DeleteBlockedRepositoryResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listBlockedEmailDomains(request: Installation.ListBlockedEmailDomainsRequest,
    ...
    "devpod.v1.InstallationService/ListBlockedEmailDomains",
      io.devpod.publicapi.v1.Installation.ListBlockedEmailDomainsRequest::class,
      io.devpod.publicapi.v1.Installation.ListBlockedEmailDomainsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.InstallationService/CreateBlockedEmailDomain",
      io.devpod.publicapi.v1.Installation.CreateBlockedEmailDomainRequest::class,
      io.devpod.publicapi.v1.Installation.CreateBlockedEmailDomainResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getOnboardingState(request: Installation.GetOnboardingStateRequest,
    ...
    "devpod.v1.InstallationService/GetOnboardingState",
      io.devpod.publicapi.v1.Installation.GetOnboardingStateRequest::class,
      io.devpod.publicapi.v1.Installation.GetOnboardingStateResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.InstallationService/GetInstallationConfiguration",
      io.devpod.publicapi.v1.Installation.GetInstallationConfigurationRequest::class,
      io.devpod.publicapi.v1.Installation.GetInstallationConfigurationResponse::class,
      StreamType.UNARY,
    ),
  )
