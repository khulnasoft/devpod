...
public class TeamsServiceClient(
  ...
  override suspend fun createTeam(request: Teams.CreateTeamRequest, headers: Headers):
    ...
    "devpod.experimental.v1.TeamsService/CreateTeam",
      io.devpod.publicapi.experimental.v1.Teams.CreateTeamRequest::class,
      io.devpod.publicapi.experimental.v1.Teams.CreateTeamResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getTeam(request: Teams.GetTeamRequest, headers: Headers):
    ...
    "devpod.experimental.v1.TeamsService/GetTeam",
      io.devpod.publicapi.experimental.v1.Teams.GetTeamRequest::class,
      io.devpod.publicapi.experimental.v1.Teams.GetTeamResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listTeams(request: Teams.ListTeamsRequest, headers: Headers):
    ...
    "devpod.experimental.v1.TeamsService/ListTeams",
      io.devpod.publicapi.experimental.v1.Teams.ListTeamsRequest::class,
      io.devpod.publicapi.experimental.v1.Teams.ListTeamsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteTeam(request: Teams.DeleteTeamRequest, headers: Headers):
    ...
    "devpod.experimental.v1.TeamsService/DeleteTeam",
      io.devpod.publicapi.experimental.v1.Teams.DeleteTeamRequest::class,
      io.devpod.publicapi.experimental.v1.Teams.DeleteTeamResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getTeamInvitation(request: Teams.GetTeamInvitationRequest, headers: Headers):
    ...
    "devpod.experimental.v1.TeamsService/GetTeamInvitation",
      io.devpod.publicapi.experimental.v1.Teams.GetTeamInvitationRequest::class,
      io.devpod.publicapi.experimental.v1.Teams.GetTeamInvitationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun joinTeam(request: Teams.JoinTeamRequest, headers: Headers):
    ...
    "devpod.experimental.v1.TeamsService/JoinTeam",
      io.devpod.publicapi.experimental.v1.Teams.JoinTeamRequest::class,
      io.devpod.publicapi.experimental.v1.Teams.JoinTeamResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun resetTeamInvitation(request: Teams.ResetTeamInvitationRequest,
    ...
    "devpod.experimental.v1.TeamsService/ResetTeamInvitation",
      io.devpod.publicapi.experimental.v1.Teams.ResetTeamInvitationRequest::class,
      io.devpod.publicapi.experimental.v1.Teams.ResetTeamInvitationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listTeamMembers(request: Teams.ListTeamMembersRequest, headers: Headers):
    ...
    "devpod.experimental.v1.TeamsService/ListTeamMembers",
      io.devpod.publicapi.experimental.v1.Teams.ListTeamMembersRequest::class,
      io.devpod.publicapi.experimental.v1.Teams.ListTeamMembersResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateTeamMember(request: Teams.UpdateTeamMemberRequest, headers: Headers):
    ...
    "devpod.experimental.v1.TeamsService/UpdateTeamMember",
      io.devpod.publicapi.experimental.v1.Teams.UpdateTeamMemberRequest::class,
      io.devpod.publicapi.experimental.v1.Teams.UpdateTeamMemberResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteTeamMember(request: Teams.DeleteTeamMemberRequest, headers: Headers):
    ...
    "devpod.experimental.v1.TeamsService/DeleteTeamMember",
      io.devpod.publicapi.experimental.v1.Teams.DeleteTeamMemberRequest::class,
      io.devpod.publicapi.experimental.v1.Teams.DeleteTeamMemberResponse::class,
      StreamType.UNARY,
    ),
  )
