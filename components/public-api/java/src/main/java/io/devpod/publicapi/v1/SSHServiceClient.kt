...
public class SSHServiceClient(
  ...
  override suspend fun listSSHPublicKeys(request: Ssh.ListSSHPublicKeysRequest, headers: Headers):
    ...
    "devpod.v1.SSHService/ListSSHPublicKeys",
      io.devpod.publicapi.v1.Ssh.ListSSHPublicKeysRequest::class,
      io.devpod.publicapi.v1.Ssh.ListSSHPublicKeysResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun createSSHPublicKey(request: Ssh.CreateSSHPublicKeyRequest, headers: Headers):
    ...
    "devpod.v1.SSHService/CreateSSHPublicKey",
      io.devpod.publicapi.v1.Ssh.CreateSSHPublicKeyRequest::class,
      io.devpod.publicapi.v1.Ssh.CreateSSHPublicKeyResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteSSHPublicKey(request: Ssh.DeleteSSHPublicKeyRequest, headers: Headers):
    ...
    "devpod.v1.SSHService/DeleteSSHPublicKey",
      io.devpod.publicapi.v1.Ssh.DeleteSSHPublicKeyRequest::class,
      io.devpod.publicapi.v1.Ssh.DeleteSSHPublicKeyResponse::class,
      StreamType.UNARY,
    ),
  )
