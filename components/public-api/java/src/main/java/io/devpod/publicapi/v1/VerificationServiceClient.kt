...
public class VerificationServiceClient(
  ...
  override suspend
    ...
    "devpod.v1.VerificationService/SendPhoneNumberVerificationToken",
      io.devpod.publicapi.v1.Verification.SendPhoneNumberVerificationTokenRequest::class,
      io.devpod.publicapi.v1.Verification.SendPhoneNumberVerificationTokenResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.VerificationService/VerifyPhoneNumberVerificationToken",
      io.devpod.publicapi.v1.Verification.VerifyPhoneNumberVerificationTokenRequest::class,
      io.devpod.publicapi.v1.Verification.VerifyPhoneNumberVerificationTokenResponse::class,
      StreamType.UNARY,
    ),
  )
