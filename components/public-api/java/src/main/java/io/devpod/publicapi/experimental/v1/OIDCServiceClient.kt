...
public class OIDCServiceClient(
  ...
  override suspend fun createClientConfig(request: Oidc.CreateClientConfigRequest,
    ...
    "devpod.experimental.v1.OIDCService/CreateClientConfig",
      io.devpod.publicapi.experimental.v1.Oidc.CreateClientConfigRequest::class,
      io.devpod.publicapi.experimental.v1.Oidc.CreateClientConfigResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getClientConfig(request: Oidc.GetClientConfigRequest, headers: Headers):
    ...
    "devpod.experimental.v1.OIDCService/GetClientConfig",
      io.devpod.publicapi.experimental.v1.Oidc.GetClientConfigRequest::class,
      io.devpod.publicapi.experimental.v1.Oidc.GetClientConfigResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listClientConfigs(request: Oidc.ListClientConfigsRequest, headers: Headers):
    ...
    "devpod.experimental.v1.OIDCService/ListClientConfigs",
      io.devpod.publicapi.experimental.v1.Oidc.ListClientConfigsRequest::class,
      io.devpod.publicapi.experimental.v1.Oidc.ListClientConfigsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateClientConfig(request: Oidc.UpdateClientConfigRequest,
    ...
    "devpod.experimental.v1.OIDCService/UpdateClientConfig",
      io.devpod.publicapi.experimental.v1.Oidc.UpdateClientConfigRequest::class,
      io.devpod.publicapi.experimental.v1.Oidc.UpdateClientConfigResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteClientConfig(request: Oidc.DeleteClientConfigRequest,
    ...
    "devpod.experimental.v1.OIDCService/DeleteClientConfig",
      io.devpod.publicapi.experimental.v1.Oidc.DeleteClientConfigRequest::class,
      io.devpod.publicapi.experimental.v1.Oidc.DeleteClientConfigResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun setClientConfigActivation(request: Oidc.SetClientConfigActivationRequest,
    ...
    "devpod.experimental.v1.OIDCService/SetClientConfigActivation",
      io.devpod.publicapi.experimental.v1.Oidc.SetClientConfigActivationRequest::class,
      io.devpod.publicapi.experimental.v1.Oidc.SetClientConfigActivationResponse::class,
      StreamType.UNARY,
    ),
  )
