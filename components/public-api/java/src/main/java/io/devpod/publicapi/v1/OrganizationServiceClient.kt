...
public class OrganizationServiceClient(
  ...
  override suspend fun createOrganization(request: OrganizationOuterClass.CreateOrganizationRequest,
    ...
    "devpod.v1.OrganizationService/CreateOrganization",
      io.devpod.publicapi.v1.OrganizationOuterClass.CreateOrganizationRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.CreateOrganizationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun getOrganization(request: OrganizationOuterClass.GetOrganizationRequest,
    ...
    "devpod.v1.OrganizationService/GetOrganization",
      io.devpod.publicapi.v1.OrganizationOuterClass.GetOrganizationRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.GetOrganizationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun updateOrganization(request: OrganizationOuterClass.UpdateOrganizationRequest,
    ...
    "devpod.v1.OrganizationService/UpdateOrganization",
      io.devpod.publicapi.v1.OrganizationOuterClass.UpdateOrganizationRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.UpdateOrganizationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun listOrganizations(request: OrganizationOuterClass.ListOrganizationsRequest,
    ...
    "devpod.v1.OrganizationService/ListOrganizations",
      io.devpod.publicapi.v1.OrganizationOuterClass.ListOrganizationsRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.ListOrganizationsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun deleteOrganization(request: OrganizationOuterClass.DeleteOrganizationRequest,
    ...
    "devpod.v1.OrganizationService/DeleteOrganization",
      io.devpod.publicapi.v1.OrganizationOuterClass.DeleteOrganizationRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.DeleteOrganizationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.OrganizationService/GetOrganizationInvitation",
      io.devpod.publicapi.v1.OrganizationOuterClass.GetOrganizationInvitationRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.GetOrganizationInvitationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend fun joinOrganization(request: OrganizationOuterClass.JoinOrganizationRequest,
    ...
    "devpod.v1.OrganizationService/JoinOrganization",
      io.devpod.publicapi.v1.OrganizationOuterClass.JoinOrganizationRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.JoinOrganizationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.OrganizationService/ResetOrganizationInvitation",
      io.devpod.publicapi.v1.OrganizationOuterClass.ResetOrganizationInvitationRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.ResetOrganizationInvitationResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.OrganizationService/ListOrganizationMembers",
      io.devpod.publicapi.v1.OrganizationOuterClass.ListOrganizationMembersRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.ListOrganizationMembersResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.OrganizationService/UpdateOrganizationMember",
      io.devpod.publicapi.v1.OrganizationOuterClass.UpdateOrganizationMemberRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.UpdateOrganizationMemberResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.OrganizationService/DeleteOrganizationMember",
      io.devpod.publicapi.v1.OrganizationOuterClass.DeleteOrganizationMemberRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.DeleteOrganizationMemberResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.OrganizationService/GetOrganizationSettings",
      io.devpod.publicapi.v1.OrganizationOuterClass.GetOrganizationSettingsRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.GetOrganizationSettingsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.OrganizationService/UpdateOrganizationSettings",
      io.devpod.publicapi.v1.OrganizationOuterClass.UpdateOrganizationSettingsRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.UpdateOrganizationSettingsResponse::class,
      StreamType.UNARY,
    ),
  )
  ...
  override suspend
    ...
    "devpod.v1.OrganizationService/ListOrganizationWorkspaceClasses",
      io.devpod.publicapi.v1.OrganizationOuterClass.ListOrganizationWorkspaceClassesRequest::class,
      io.devpod.publicapi.v1.OrganizationOuterClass.ListOrganizationWorkspaceClassesResponse::class,
      StreamType.UNARY,
    ),
  )
