...
Example:
  # Disable telemetry
  devpod config set --telemetry=false

  # Disable autoupdate
  devpod config set --autoupdate=false

  # Enable telemetry and autoupdate
  devpod config set --telemetry=true --autoupdate=true

  # Set your current context's organization
  devpod config set --organization-id=your-org-id
`,
