...
export class Baseline1592203031938 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        const createTables = [
            ...
            `CREATE TABLE IF NOT EXISTS d_b_devpod_token (  tokenHash varchar(255) NOT NULL,  name varchar(255) DEFAULT NULL,  type int(11) NOT NULL,  userId char(36) NOT NULL,  scopes varchar(255) NOT NULL DEFAULT '',  created varchar(255) NOT NULL DEFAULT '',  deleted tinyint(4) NOT NULL DEFAULT '0',  _lastModified timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),  PRIMARY KEY (tokenHash),  KEY ind_lastModified (_lastModified),  KEY ind_userId (userId)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;`,
