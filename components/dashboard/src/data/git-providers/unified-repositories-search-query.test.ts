...
test("should perform weak validation for git URLs", () => {
    ...
    expect(isValidGitUrl("https://github.com/khulnasoft/devpod/pull/20281")).toEqual(true);
    expect(isValidGitUrl("https://gitlab.com/filiptronicek/devpod.git")).toEqual(true);
    expect(isValidGitUrl("git@github.com:khulnasoft/devpod.git")).toEqual(true);
    expect(isValidGitUrl("git@gitlab.com:filiptronicek/devpod.git")).toEqual(true);
    expect(isValidGitUrl("ssh://login@server.com:12345/~/repository.git")).toBe(true);
    expect(isValidGitUrl("https://bitbucket.devpod-dev.com/scm/~geropl/test-user-repo.git")).toBe(true);
    expect(isValidGitUrl("git://gitlab.com/devpod/spring-petclinic")).toBe(true);
