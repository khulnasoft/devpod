...
export interface StartWorkspaceProps {
    ...
    /**
     * This flag is used to break the autostart-cycle explained in https://github.com/khulnasoft/devpod/issues/8043
     */
...
export default class StartWorkspace extends React.Component<StartWorkspaceProps, StartWorkspaceState> {
    ...
    async startWorkspace(restart = false, forceDefaultConfig = false) {
        ...
        try {
            ...
            if (normalizedError?.code === ErrorCodes.USER_BLOCKED) {
                this.redirectTo(devpodHostUrl.with({ pathname: "/blocked" }).toString());
                return;
            }
    ...
    private async onWorkspaceUpdate(workspace?: Workspace) {
        ...
        if (
            ...
            if (contextURL) {
                this.redirectTo(devpodHostUrl.withContext(contextURL.toString()).toString());
            } else {
    ...
    async ensureWorkspaceAuth(instanceID: string, retry: boolean) {
        ...
        while (attempt <= MAX_ATTEMPTS) {
            ...
            try {
                const authURL = devpodHostUrl.asWorkspaceAuth(instanceID);
                                ...
                                <ContextMenu
                                    menuEntries={[
                                        ...
                                        },
                                        {
                                            ...
                                            href: devpodHostUrl.asWorkspacePage().toString(),
                                            target: "_parent",
                                        },
                                    ]}
                                >
                            ...
                            {!useLatest && (
                                <Alert type="info" className="mt-4 w-96">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        href={devpodHostUrl.asPreferences().toString()}
                                    >
                                        user preferences
                                    </a>
                                    .
                ...
                statusMessage = (
                    <div>
                        ...
                        <div className="mt-10 flex justify-center">
                            <a target="_parent" href={devpodHostUrl.asWorkspacePage().toString()}>
                ...
                statusMessage = (
                    <div>
                        ...
                        <div className="mt-10 justify-center flex space-x-2">
                            ...
                            <a target="_parent" href={devpodHostUrl.asStart(this.state.workspace.id).toString()}>
                ...
                {this.state.showRedirectMessage && (
                    <>
                        ...
                        <div className="mt-4 justify-center flex space-x-2">
                            <LinkButton href={devpodHostUrl.asWorkspacePage().toString()} target="_self" isExternalUrl>
                                Go to Dashboard
                            </LinkButton>
