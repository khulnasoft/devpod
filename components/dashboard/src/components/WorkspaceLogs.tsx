...
const darkTheme: ITheme = {
    ...
    selectionBackground: "#add6ff26", // https://github.com/khulnasoft/devpod-vscode-theme/blob/6fb17ba8915fcd68fde3055b4bc60642ce5eed14/themes/devpod-dark-color-theme.json#L15
};
const lightTheme: ITheme = {
    ...
    selectionBackground: "#add6ff80", // https://github.com/khulnasoft/devpod-vscode-theme/blob/6fb17ba8915fcd68fde3055b4bc60642ce5eed14/themes/devpod-light-color-theme.json#L15
};
