...
DB_CA_CERT and DB_USER(=devpod)`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// Must be "devpod"
		// Align to https://github.com/khulnasoft/devpod/blob/884d922e8e33d8b936ec18d7fe3c8dcffde42b5a/components/devpod-db/go/conn.go#L37
		cfg.DBName = "devpod"
...
func init() {
	...
	databaseCmd.Flags().StringP("username", "u", envOrDefault("DB_USERNAME", "devpod"), "Username to use when connected")
