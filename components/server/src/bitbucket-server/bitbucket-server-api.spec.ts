...
class TestBitbucketServerApi {
    ...
    @test async test_getRepos_no_searchString() {
        ...
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=0&limit=1000 - OK
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=1002&limit=1000 - OK
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=2002&limit=1000 - OK
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=3002&limit=1000 - OK
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=4002&limit=1000 - OK
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=5002&limit=1000 - OK
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=6002&limit=1000 - OK
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=7002&limit=1000 - OK
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=8002&limit=1000 - OK
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=9002&limit=1000 - OK
    ...
    @test async test_getRepos_searchString() {
        ...
        expect(result[0].links.clone[0].href).to.equal("https://bitbucket.devpod-dev.com/scm/tes/zero-minus-1.git");

        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=0&name=zero - OK
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=0&projectname=zero - OK
    ...
    @test async test_getRepos_searchString_2() {
        ...
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=0&name=zero-minus-1 - OK
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=0&projectname=zero-minus-1 - OK
    ...
    @test async test_getRepos_searchString_unmatched() {
        ...
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=0&name=RANDOM_asd8sdh7s8hsdhvisduh - OK
        // BBS: GET https://bitbucket.devpod-dev.com/rest/api/1.0/repos?permission=REPO_READ&limit=1000&start=0&projectname=RANDOM_asd8sdh7s8hsdhvisduh - OK
