...
class TestBitbucketServerRepositoryProvider {
    ...
    @test async test_getRepo_ok() {
        ...
        expect(result).to.deep.include({
            webUrl: "https://bitbucket.devpod-dev.com/projects/TES/repos/2k-repos-1076",
            cloneUrl: "https://bitbucket.devpod-dev.com/scm/tes/2k-repos-1076.git",
        });
    }
    ...
    @test async test_getUserRepos_ok() {
        ...
        expect(result).to.deep.include({
            url: "https://bitbucket.devpod-dev.com/scm/~svenefftinge/browser-extension-test.git",
