...
class TestBitbucketServerContextParser {
    ...
    @test async test_tree_context_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.devpod-dev.com/projects/GIT/repos/devpod-test-repo",
        );
        ...
        expect(result).to.deep.include({
            ...
            title: "GIT/devpod-test-repo - master",
        });
    }
    ...
    @test async test_tree_context_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.devpod-dev.com/scm/git/devpod-test-repo.git",
        );
    ...
    @test async test_tree_context_03_user_repo() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.devpod-dev.com/scm/~geropl/test-user-repo.git",
        );
        ...
        expect(result).to.deep.include({
            ...
            repository: {
                ...
                cloneUrl: "https://bitbucket.devpod-dev.com/scm/~geropl/test-user-repo.git",
                webUrl: "https://bitbucket.devpod-dev.com/users/geropl/repos/test-user-repo",
                defaultBranch: "main",
                private: true,
                repoKind: "users",
            },
    ...
    @test async test_commit_context_01_user_repo() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.devpod-dev.com/users/geropl/repos/test-user-repo/commits/153ceae2a36f7e0b320ac72b593164efe11cd4ad",
        );
    ...
    @test async test_commit_context_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.devpod-dev.com/projects/GIT/repos/devpod-test-repo/commits/506e5aed317f28023994ecf8ca6ed91430e9c1a4",
        );
        ...
        expect(result).to.deep.include({
            ...
            title: "GIT/devpod-test-repo - 506e5aed317f28023994ecf8ca6ed91430e9c1a4",
        });
    }
    ...
    @test async test_commit_context_03_with_branch_ref() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.devpod-dev.com/projects/GIT/repos/devpod-test-repo/commits/506e5aed317f28023994ecf8ca6ed91430e9c1a4#master",
        );
    ...
    @test async test_branch_context_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.devpod-dev.com/users/svenefftinge/repos/browser-extension-test/commits?until=refs%2Fheads%2Fmy-branch&merges=include",
        );
        ...
        expect(result).to.deep.include({
            ...
            isFile: false,
            repository: {
                cloneUrl: "https://bitbucket.devpod-dev.com/scm/~svenefftinge/browser-extension-test.git",
                defaultBranch: "main",
                host: "bitbucket.devpod-dev.com",
                ...
                repoKind: "users",
                private: false,
                webUrl: "https://bitbucket.devpod-dev.com/users/svenefftinge/repos/browser-extension-test",
            },
    ...
    @test async test_branch_context_02() {
        const result = await this.parser.handle(
            ...
            "https://bitbucket.devpod-dev.com/users/svenefftinge/repos/browser-extension-test/commits?until=my-branch&merges=include",
        );
    ...
    @test async test_PR_context_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.devpod-dev.com/projects/GIT/repos/devpod-test-repo/pull-requests/1/commits",
        );
    ...
    @test async test_PR_context_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.devpod-dev.com/projects/GIT/repos/devpod-test-repo/pull-requests/1/overview",
        );
    ...
    @test async test_tag_context_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.devpod-dev.com/projects/GIT/repos/devpod-test-repo/browse?at=refs%2Ftags%2Ftest-tag-v1.0.1",
        );

        expect(result).to.deep.include({
            title: "GIT/devpod-test-repo - test-tag-v1.0.1",
            ref: "test-tag-v1.0.1",
            refType: "tag",
            revision: "506e5aed317f28023994ecf8ca6ed91430e9c1a4",
            repository: {
    ...
    @test async test_tag_context_02() {
        const result = await this.parser.handle(
            ...
            "https://bitbucket.devpod-dev.com/projects/GIT/repos/devpod-test-repo/browse?at=test-tag-v1.0.1",
        );
    ...
    @test test_toSimpleBranchName() {
        const url = new URL(
            "https://bitbucket.devpod-dev.com/projects/GIT/repos/devpod-test-repo/browse?at=refs%2Fheads%2Ffoo",
        );
