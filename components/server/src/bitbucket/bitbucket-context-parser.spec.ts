...
class TestBitbucketContextParser {
    ...
    @test public testCanHandleBitbucketRepo() {
        expect(this.parser.canHandle(this.user, "https://bitbucket.org/devpod/integration-tests/src/master/")).to.be
            .true;
    }
    ...
    @test public async testShortContext_01() {
        const result = await this.parser.handle({}, this.user, "https://bitbucket.org/devpod/integration-tests");
        expect(result).to.deep.include({
            ...
            repository: {
                ...
                cloneUrl: "https://bitbucket.org/devpod/integration-tests.git",
                defaultBranch: "master",
                private: false,
            },
            title: "devpod/integration-tests - master",
        });
    }
    ...
    @test public async testSrcContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/src/master/",
        );
        expect(result).to.deep.include({
            ref: "master",
            refType: "branch",
    ...
    @test public async testSrcContext_03() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/src/second-branch/",
        );
        expect(result).to.deep.include({
            ref: "second-branch",
            refType: "branch",
            ...
            title: "devpod/integration-tests - second-branch",
        });
    }
    ...
    @test public async testCommitsContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/commits/branch/second-branch",
        );
        expect(result).to.deep.include({
            ref: "second-branch",
            refType: "branch",
    ...
    @test public async testBranchContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/branch/master/",
        );
        expect(result).to.deep.include({
            ref: "master",
            refType: "branch",
    ...
    @test public async testBranchContext_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/branch/second-branch",
        );
        expect(result).to.deep.include({
            ref: "second-branch",
            refType: "branch",
    ...
    @test public async testBranchContext_03() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/branch/feature/JIRA-123-summary",
        );
        expect(result).to.deep.include({
            ...
            title: "devpod/integration-tests - feature/JIRA-123-summary",
        });
    }
    ...
    @test public async testCommitsContext_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/commits/tag/first-tag",
        );
        expect(result).to.deep.include({
            ref: "first-tag",
            refType: "tag",
            ...
            title: "devpod/integration-tests - first-tag",
        });
    }
    ...
    @test public async testSrcContext_04() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/src/first-tag/",
        );
        expect(result).to.deep.include({
            ref: "first-tag",
            refType: "tag",
    ...
    @test public async testCommitsContext_03() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/commits/5a24a0c8a7b42c2e6418593d788e17cb987bda25",
        );
        expect(result).to.deep.include({
            ref: "",
            refType: "revision",
            ...
            title: "devpod/integration-tests - 5a24a0c8a7b42c2e6418593d788e17cb987bda25",
        });
    }
    ...
    @test public async testFileContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/src/master/README.md",
        );
        expect(result).to.deep.include({
            ref: "master",
            refType: "branch",
            ...
            title: "devpod/integration-tests - master:README.md",
        });
    }
    ...
    @test public async testFileContext_02() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/src/branch-with-dir/my-dir/test.txt",
        );
        expect(result).to.deep.include({
            ref: "branch-with-dir",
            refType: "branch",
            ...
            title: "devpod/integration-tests - branch-with-dir:my-dir/test.txt",
        });
    }
    ...
    @test public async testDirectoryContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/src/branch-with-dir/my-dir/",
        );
        expect(result).to.deep.include({
            ref: "branch-with-dir",
            refType: "branch",
            ...
            title: "devpod/integration-tests - branch-with-dir:my-dir",
        });
    }
    ...
    @test public async testPullRequestContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/pull-requests/1/readme-updated/diff",
        );
        expect(result).to.deep.include({
    ...
    @test public async testIssueContext_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests/issues/1/first-issue",
        );
        expect(result).to.deep.include({
            title: "First issue",
            repository: {
    ...
    @test public async testSrcContextForkedRepo_01() {
        const result = await this.parser.handle(
            {},
            this.user,
            "https://bitbucket.org/devpod/integration-tests-forked-repository/src/master/",
        );
        expect(result).to.deep.include({
            ref: "master",
            refType: "branch",
            ...
            repository: {
                ...
                cloneUrl: "https://bitbucket.org/devpod/integration-tests-forked-repository.git",
                defaultBranch: "master",
                private: false,
                fork: {
                    parent: {
            ...
            title: "devpod/integration-tests-forked-repository - master",
        });
    }
}
