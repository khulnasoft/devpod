...
import { Organization, SSHPublicKeyValue, User } from "@devpod/devpod-protocol";
...
describe("SSHKeyService", async () => {
    ...
    const testSSHkeys: SSHPublicKeyValue[] = [
        {
            name: "foo",
            key: "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBN+Mh3U/3We4VYtV1QmWUFIzFLTUeegl1Ao5/QGtCRGAZn8bxX9KlCrrWISIjSYAwCajIEGSPEZwPNMBoK8XD8Q= test@devpod",
        },
        {
            name: "bar",
            key: "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIK0wmN/Cr3JXqmLW7u+g9pTh+wyqDHpSQEIQczXkVx9q bar@devpod",
        },
    ];
