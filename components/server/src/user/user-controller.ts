    ...
    get apiRouter(): express.Router {
        ...
        router.get(
            ...
            loginUserWithOts(async (req: express.Request, res: express.Response, user: User, secret: string) => {
                // This mechanism is used by integration tests, cmp. https://github.com/khulnasoft/devpod/blob/478a75e744a642d9b764de37cfae655bc8b29dd5/test/tests/ide/vscode/python_ws_test.go#L105
