                ...
                return (...args: any[]) => {
                    ...
                    const handleError = (reason: unknown) => {
                        ...
                        if (
                            ...
                            // Compare https://linear.app/devpod/issue/ENT-232 and https://github.com/khulnasoft/devpod/pull/19827
                    ...
                    if (grpc_type === "unary" || grpc_type === "client_stream") {
                        return withRequestContext(async () => {
                            ...
                            if (
                                isCellDisabled &&
                                requestContext.requestMethod === "devpod.v1.UserService/getAuthenticatedUser"
                            ) {
