...
export class MockImageSourceProvider extends ImageSourceProvider {
    public imageSource: WorkspaceImageSource = { baseImageResolved: "devpod/workspace-full:latest" };
...
describe("WorkspaceFactory", async () => {
    ...
    it("createForPrebuiltWorkspace_noPrebuild", async () => {
        ...
        const contextURL = "https://github.com/khulnasoft/devpod/tree/gpl/test";
