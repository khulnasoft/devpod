...
export class WorkspaceService {
    ...
    public async validateImageRef(ctx: TraceContext, user: User, imageRef: string, organizationId?: string) {
        try {
            ...
            // see https://github.com/khulnasoft/devpod/blob/f3e41f8d86234e4101edff2199c54f50f8cbb656/components/image-builder-mk3/pkg/orchestrator/orchestrator.go#L561
