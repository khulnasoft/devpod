...
describe("PersonalAccessToken", () => {
    it("should parse token successfully", () => {
        const token = "devpod_pat_GrvGthczSRf3ypqFhNtcRiN5fK6CV7rdCkkPLfpbc_4." + "test".repeat(10);
    ...
    it("should parse token and throw an error", () => {
        const tokens = [
            "devpod_pat_GrvGthczSRf3ypqFhNtcRiN5fK6CV7rdCkkPLfpbc_4.", // no value
            `devpod_pat_.${"test".repeat(10)}`, // no signature
