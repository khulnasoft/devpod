...
export class GithubApp {
    ...
    private async buildApp(app: Probot, options: ApplicationFunctionOptions) {
        ...
        // Backward-compatibility: Redirect old badge URLs (e.g. "/api/apps/github/pbs/github.com/khulnasoft/devpod/5431d5735c32ab7d5d840a4d1a7d7c688d1f0ce9.svg")
        options.getRouter &&
            options
                .getRouter("/pbs")
    ...
    private async handlePushEvent(ctx: Context<"push">): Promise<void> {
        ...
        // https://github.com/khulnasoft/devpod/issues/11578
    ...
    private getBadgeImageURL(): string {
        return this.config.hostUrl.with({ pathname: "/button/open-in-devpod.svg" }).toString();
    }
