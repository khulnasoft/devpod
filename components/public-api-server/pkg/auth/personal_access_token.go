...
const PersonalAccessTokenPrefix = "devpod_pat_"
...
// The PersonalAccessToken, in string form, takes the following shape: devpod_pat_<signature>.<value>
// E.g. devpod_pat_ko8KC1tJ-GkqIwqNliwF4tBUk2Jd5nEe9qOWqYfobtY.6ZDQVanpaTKj9hQuji0thCe8KFCcmEDGpsaTkSSb
...
func ParsePersonalAccessToken(token string, signer Signer) (PersonalAccessToken, error) {
	...
	// Assume we start with the following token: devpod_pat_ko8KC1tJ-GkqIwqNliwF4tBUk2Jd5nEe9qOWqYfobtY.6ZDQVanpaTKj9hQuji0thCe8KFCcmEDGpsaTkSSb
