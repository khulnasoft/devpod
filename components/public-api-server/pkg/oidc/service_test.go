...
func Test_verifyCelExpression(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			CEL: "claims.email_verified && claims.email_verified.email.endsWith('@devpod.io')",
		},
		{
			...
			CEL: "(claims.email_verified && claims.email_verified.email.endsWith('@devpod.io')) || 'devpod-team' in claims.groups_direct",
		},
		{
			...
			CEL: "(claims.email_verified && claims.email_verified.email.endsWith('@devpod.io')) || 'devpod-team2' in claims.groups_direct",
		},
		{
