...
func init() {
	...
	publicApiCmd.PersistentFlags().StringVar(&publicApiCmdOpts.address, "address", "api.main.preview.devpod-dev.com:443", "Address of the API endpoint. Must be in the form <host>:<port>.")
