        ...
        if (top) {
            ...
            const [avgMax, maxMax, q90Max, avgUsed, maxUsed, q90user] = (
                await Promise.allSettled([
                    query("avg_over_time(devpod_jb_backend_memory_max_bytes"),
                    query("max_over_time(devpod_jb_backend_memory_max_bytes"),
                    query("quantile_over_time(0.9, devpod_jb_backend_memory_max_bytes"),
                    query("avg_over_time(devpod_jb_backend_memory_used_bytes"),
                    query("max_over_time(devpod_jb_backend_memory_used_bytes"),
                    query("quantile_over_time(0.9, devpod_jb_backend_memory_used_bytes"),
                ])
            ).map((v) => {
