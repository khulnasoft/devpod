...
import (
	...
	"github.com/khulnasoft/devpod/loadgen/pkg/loadgen"
	"github.com/khulnasoft/devpod/loadgen/pkg/observer"
		...
		template := &api.StartWorkspaceRequest{
			...
			Spec: &api.StartWorkspaceSpec{
				IdeImage: &api.IDEImage{
					WebRef: "eu.gcr.io/devpod-core-dev/build/ide/code:commit-8c1466008dedabe79d82cbb91931a16f7ce7994c",
				},
