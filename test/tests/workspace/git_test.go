	...
	tests := []GitTest{
		{
			...
			ContextURL:    "github.com/khulnasoft/devpod-test-repo/tree/integration-test/commit",
		...
		},
		{
			...
			ContextURL:    "github.com/khulnasoft/devpod-test-repo/tree/integration-test/commit-and-push",
			WorkspaceRoot: "/workspace/devpod-test-repo",
			Action: func(rsa *integration.RpcClient, git integration.GitClient, workspaceRoot string) (err error) {
				var resp agent.ExecResponse
				err = rsa.Call("WorkspaceAgent.Exec", &agent.ExecRequest{
