...
import (
	...
	"github.com/khulnasoft/devpod/test/pkg/report"
)
...
func TestGitHubContexts(t *testing.T) {
	tests := []ContextTest{
		...
		{
			Name:           "open branch",
			ContextURL:     "github.com/khulnasoft/devpod-test-repo/tree/integration-test-1",
			WorkspaceRoot:  "/workspace/devpod-test-repo",
			ExpectedBranch: "integration-test-1",
		},
		{
			// Branch name decisions are not tested in the workspace as it is the server side logic
			Name:          "open issue",
			ContextURL:    "github.com/khulnasoft/devpod-test-repo/issues/88",
			WorkspaceRoot: "/workspace/devpod-test-repo",
		},
		{
			Name:           "open tag",
			ContextURL:     "github.com/khulnasoft/devpod-test-repo/tree/integration-test-context-tag",
			WorkspaceRoot:  "/workspace/devpod-test-repo",
			ExpectedBranch: "HEAD",
		},
		{
