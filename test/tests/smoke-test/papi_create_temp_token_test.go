...
import (
	...
	v1connect "github.com/khulnasoft/devpod/components/public-api/go/v1/v1connect"
)
...
go test -run "^TestCreateTemporaryAccessToken" github.com/khulnasoft/devpod/test/tests/smoke-test -v -count=1
*/
...
func TestCreateTemporaryAccessToken(t *testing.T) {
	...
	assertGetUser(ctx, t, devpodHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, "")
	newTargetToken := assertTemporaryAccessToken(ctx, t, devpodHost, adminPAT, targetUserID, 60, "")
	if newTargetToken == "" {
		return
	}

	assertGetUser(ctx, t, devpodHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, "")
	assertGetUser(ctx, t, devpodHost, newTargetToken, targetUserID, "")
}
...
func TestCreateTemporaryAccessTokenDeniedToCreateInstallationAdmin(t *testing.T) {
	...
	assertGetUser(ctx, t, devpodHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, "")
	assertTemporaryAccessToken(ctx, t, devpodHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, 60, "permission_denied")
}
...
func TestCreateTemporaryAccessTokenWithNotFoundUser(t *testing.T) {
	...
	assertGetUser(ctx, t, devpodHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, "")
	assertTemporaryAccessToken(ctx, t, devpodHost, adminPAT, "00000000-0000-0000-0000-000000000000", 60, "not_found")
}
...
func TestCreateTemporaryAccessTokenViaMember(t *testing.T) {
	...
	assertGetUser(ctx, t, devpodHost, memberUserPAT, memberUserID, "")
	assertTemporaryAccessToken(ctx, t, devpodHost, memberUserPAT, targetUserID, 60, "permission_denied")
}
...
func TestCreateTemporaryAccessTokenExpiry(t *testing.T) {
	...
	assertGetUser(ctx, t, devpodHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, "")
	newTargetToken := assertTemporaryAccessToken(ctx, t, devpodHost, adminPAT, targetUserID, 3, "")
	if newTargetToken == "" {
		return
	}
	assertGetUser(ctx, t, devpodHost, adminPAT, BUILTIN_INSTLLATION_ADMIN_USER_ID, "")
	...
	assertGetUser(ctx, t, devpodHost, newTargetToken, targetUserID, "unauthenticated")
}
...
func TestCreateTemporaryAccessTokenCreateEnv(t *testing.T) {
	...
	assertCreateEnvVar(ctx, t, devpodHost, newTargetToken, "foo", "boo")
}

func assertTemporaryAccessToken(ctx context.Context, t *testing.T, devpodHost, userToken, targetUserID string, expirySeconds int32, wantedErrMsg string) string {
	useCookie := !strings.HasPrefix(userToken, "devpod_pat_")
	v1Http, v1Opts, v1Host := getPAPIConnSettings(devpodHost, userToken, useCookie, false)
...
func assertGetUser(ctx context.Context, t *testing.T, devpodHost, userToken string, wantedUser, wantedErrMsg string) {
	useCookie := !strings.HasPrefix(userToken, "devpod_pat_")
	v1Http, v1Opts, v1Host := getPAPIConnSettings(devpodHost, userToken, useCookie, false)
...
func assertCreateEnvVar(ctx context.Context, t *testing.T, devpodHost, userToken string, envVarName, envVarVal string) {
	useCookie := !strings.HasPrefix(userToken, "devpod_pat_")
	v1Http, v1Opts, v1Host := getPAPIConnSettings(devpodHost, userToken, useCookie, false)
